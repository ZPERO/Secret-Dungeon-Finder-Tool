  ...
  implements LinearSystem.Row
{
  ...
  boolean hasKeyVariable()
  {
    ...
    return (localSolverVariable != null) && ((mType == SolverVariable.Type.UNRESTRICTED) || (constantValue >= 0.0F));
  }
  ...
  public void initFromRow(LinearSystem.Row paramRow)
  {
    if ((paramRow instanceof ArrayRow))
    {
      ...
      while (i < variables.currentSize)
      {
        ...
        variables.intersect(localSolverVariable, f, true);
        i += 1;
      }
    }
  }
  ...
  void pivot(SolverVariable paramSolverVariable)
  {
    ...
    {
      variables.combine(localSolverVariable, -1.0F);
      variable = null;
    }
