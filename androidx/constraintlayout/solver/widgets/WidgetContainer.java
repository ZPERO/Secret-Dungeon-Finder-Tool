  ...
  extends ConstraintWidget
{
  ...
  public void addFiles(ConstraintWidget... paramVarArgs)
  {
    int j = paramVarArgs.length;
    int i = 0;
    while (i < j)
    {
      close(paramVarArgs[i]);
      i += 1;
    }
  }
  
  public void close(ConstraintWidget paramConstraintWidget)
  {
  ...
  public void layout()
  {
    ...
    while (i < j)
    {
      localObject = (ConstraintWidget)mChildren.get(i);
