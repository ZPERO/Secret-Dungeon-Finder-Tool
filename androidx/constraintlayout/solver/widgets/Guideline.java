  ...
  extends ConstraintWidget
{
  ...
  public void addToSolver(LinearSystem paramLinearSystem)
  {
    ...
    ConstraintAnchor localConstraintAnchor = ((ConstraintWidget)localObject2).getAnchor(ConstraintAnchor.Type.LEFT);
    Object localObject1 = ((ConstraintWidget)localObject2).getAnchor(ConstraintAnchor.Type.RIGHT);
    int i;
    ...
    if (mOrientation == 0)
    {
      localConstraintAnchor = ((ConstraintWidget)localObject2).getAnchor(ConstraintAnchor.Type.MIDDLE);
      localObject1 = ((ConstraintWidget)localObject2).getAnchor(ConstraintAnchor.Type.BOTTOM);
  ...
  {
    Rectangle localRectangle = mHead;
    int i = getDrawX();
    int j = mHeadSize;
    int k = getDrawY();
    int m = mHeadSize;
