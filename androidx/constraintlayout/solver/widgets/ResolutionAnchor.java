  ...
  extends ResolutionNode
{
  ...
  void addResolvedValue(LinearSystem paramLinearSystem)
  {
    ...
    ResolutionAnchor localResolutionAnchor = resolvedTarget;
    if (localResolutionAnchor == null)
    {
      paramLinearSystem.addEquality(localSolverVariable, (int)(resolvedOffset + 0.5F));
      return;
    }
    paramLinearSystem.addEquality(localSolverVariable, paramLinearSystem.createObjectVariable(myAnchor), (int)(resolvedOffset + 0.5F), 6);
  }
  ...
  {
    ResolutionDimension localResolutionDimension = dimension;
    if (localResolutionDimension == paramResolutionDimension)
    {
      dimension = null;
      offset = dimensionMultiplier;
    }
    else if (localResolutionDimension == oppositeDimension)
    {
  ...
  public void resolve()
  {
    ...
    localObject1 = oppositeDimension;
    if (localObject1 != null)
    {
      if (state != 1) {
        return;
    ...
    if (type == 1)
    {
      ...
      if ((localObject1 == null) || (state == 1))
      {
        ...
        else
        {
          ...
          resolvedOffset = (resolvedOffset + offset);
        }
        didResolve();
        return;
      }
      ...
      if ((localObject1 != null) && (state == 1))
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((localObject1 != null) && (state == 1))
          {
            ...
            if (i != 0)
            {
              f1 = target.resolvedOffset;
              f2 = opposite.target.resolvedOffset;
            }
            else
            {
              f1 = opposite.target.resolvedOffset;
            ...
            {
              localObject1 = opposite;
              resolvedOffset = (target.resolvedOffset + f4 + f2 * f1);
            ...
            else
            {
              ...
              localObject1 = opposite;
              resolvedOffset = (target.resolvedOffset - f4 - f2 * (1.0F - f1));
            }
            didResolve();
            opposite.didResolve();
            return;
      ...
      if ((localObject1 != null) && (state == 1))
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((localObject1 != null) && (state == 1))
          {
            ...
            localObject1 = target;
            resolvedTarget = resolvedTarget;
            localObject2 = opposite;
            ResolutionAnchor localResolutionAnchor = target;
            resolvedTarget = resolvedTarget;
            resolvedOffset = (resolvedOffset + offset);
            resolvedOffset = (resolvedOffset + offset);
            didResolve();
