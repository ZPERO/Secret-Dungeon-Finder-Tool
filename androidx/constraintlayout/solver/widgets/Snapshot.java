...
public class Snapshot
{
  ...
  {
    x = paramConstraintWidget.getX();
    y = paramConstraintWidget.getY();
  ...
  {
    paramConstraintWidget.setX(x);
    paramConstraintWidget.setY(y);
  ...
  static class Connection
  {
    ...
    public void updateFrom(ConstraintWidget paramConstraintWidget)
    {
      ...
      paramConstraintWidget = mAnchor;
      if (paramConstraintWidget != null)
      {
        mTarget = paramConstraintWidget.getTarget();
