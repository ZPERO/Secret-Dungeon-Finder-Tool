      ...
      if ((target.state == 1) && (target.state == 1))
      {
        ...
        if ((n > 0) && (n == m))
        {
          ...
          while (localObject1 != null)
          {
            ...
            paramConstraintWidgetContainer = mNextChainWidget[paramInt1];
            if (paramConstraintWidgetContainer == null)
            {
              f1 = f4;
            ...
            else
            {
              ...
              paramChainHead = mListAnchors[i1].getResolutionNode();
              localObject3 = resolvedTarget;
              f1 = f3 + f1;
              paramChainHead.resolve((ResolutionAnchor)localObject3, f1);
        ...
        if (k != 0)
        {
          ...
          for (f1 = f4 + (f6 - f1) * ((ConstraintWidget)localObject1).getBiasPercent(paramInt1); paramConstraintWidgetContainer != null; f1 = f2)
          {
            if (LinearSystem.sMetrics != null)
            {
        ...
        for (;;)
        {
          ...
          for (paramConstraintWidgetContainer = paramChainHead; paramConstraintWidgetContainer != null; paramConstraintWidgetContainer = paramChainHead)
          {
            if (LinearSystem.sMetrics != null)
            {
              paramChainHead = LinearSystem.sMetrics;
