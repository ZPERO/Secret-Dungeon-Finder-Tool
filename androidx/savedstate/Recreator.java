  ...
  implements GenericLifecycleObserver
{
  ...
  private void reflectiveNew(String paramString)
  {
    ...
    //   38: astore_2
    //   39: aload_2
    //   40: checkcast 46	androidx/savedstate/SavedStateRegistry$AutoRecreated
    //   43: aload_0
  ...
  public void onStateChanged(LifecycleOwner paramLifecycleOwner, Lifecycle.Event paramEvent)
  {
    if (paramEvent == Lifecycle.Event.ON_CREATE)
    {
      ...
      paramLifecycleOwner = mOwner.getSavedStateRegistry().consumeRestoredStateForKey("androidx.savedstate.Restarter");
    ...
    implements SavedStateRegistry.SavedStateProvider
  {
    ...
    public Bundle saveState()
    {
      ...
      localBundle.putStringArrayList("classes_to_restore", new ArrayList(mClasses));
      return localBundle;
    }
    
    void setRemote(String paramString)
    {
      mClasses.add(paramString);
    }
  }
}
