...
public final class SparseIntArrayKt
{
  ...
  public static final void drop(SparseIntArray paramSparseIntArray, int paramInt1, int paramInt2)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseIntArray, "$this$set");
    paramSparseIntArray.put(paramInt1, paramInt2);
  }
  
  public static final void forEach(SparseIntArray paramSparseIntArray, Function2 paramFunction2)
  {
  ...
  public static final int getOrElse(SparseIntArray paramSparseIntArray, int paramInt, Function0 paramFunction0)
  {
  ...
  public static final IntIterator keyIterator(SparseIntArray paramSparseIntArray)
  {
    ...
    (IntIterator)new IntIterator()
    {
      ...
      public int nextInt()
      {
        SparseIntArray localSparseIntArray = SparseIntArrayKt.this;
        int i = index;
        index = (i + 1);
