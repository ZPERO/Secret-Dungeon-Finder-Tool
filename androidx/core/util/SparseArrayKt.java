...
{
  public static final boolean contains(SparseArray paramSparseArray, int paramInt)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$contains");
    return paramSparseArray.indexOfKey(paramInt) >= 0;
  }
  
  public static final boolean containsKey(SparseArray paramSparseArray, int paramInt)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$containsKey");
    return paramSparseArray.indexOfKey(paramInt) >= 0;
  }
  
  public static final boolean containsValue(SparseArray paramSparseArray, Object paramObject)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$containsValue");
    return paramSparseArray.indexOfValue(paramObject) != -1;
  }
  
  public static final void forEach(SparseArray paramSparseArray, Function2 paramFunction2)
  {
  ...
  public static final Object getOrDefault(SparseArray paramSparseArray, int paramInt, Object paramObject)
  {
  ...
  public static final Object getOrElse(SparseArray paramSparseArray, int paramInt, Function0 paramFunction0)
  {
  ...
  public static final int getSize(SparseArray paramSparseArray)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$size");
    return paramSparseArray.size();
  }
  
  public static final boolean isEmpty(SparseArray paramSparseArray)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$isEmpty");
    return paramSparseArray.size() == 0;
  }
  
  public static final boolean isNotEmpty(SparseArray paramSparseArray)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$isNotEmpty");
    return paramSparseArray.size() != 0;
  }
  
  public static final IntIterator keyIterator(SparseArray paramSparseArray)
  {
    ...
    (IntIterator)new IntIterator()
    {
      ...
      public int nextInt()
      {
        SparseArray localSparseArray = SparseArrayKt.this;
        int i = index;
        index = (i + 1);
  ...
  public static final SparseArray plus(SparseArray paramSparseArray1, SparseArray paramSparseArray2)
  {
  ...
  public static final void putAll(SparseArray paramSparseArray1, SparseArray paramSparseArray2)
  {
  ...
  public static final boolean remove(SparseArray paramSparseArray, int paramInt, Object paramObject)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$remove");
    paramInt = paramSparseArray.indexOfKey(paramInt);
    if ((paramInt != -1) && (Intrinsics.areEqual(paramObject, paramSparseArray.valueAt(paramInt))))
    {
  ...
  public static final void setData(SparseArray paramSparseArray, int paramInt, Object paramObject)
  {
    Intrinsics.checkParameterIsNotNull(paramSparseArray, "$this$set");
    paramSparseArray.put(paramInt, paramObject);
  }
  
  public static final Iterator valueIterator(SparseArray paramSparseArray)
  {
