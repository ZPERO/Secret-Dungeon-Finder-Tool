...
public class AccessibilityNodeInfoCompat
{
  ...
  private List extrasCharSequenceList(String paramString)
  {
    if (Build.VERSION.SDK_INT < 19) {
      return new ArrayList();
    }
    ArrayList localArrayList2 = mInfo.getExtras().getCharSequenceArrayList(paramString);
    ArrayList localArrayList1 = localArrayList2;
    if (localArrayList2 == null)
    {
      localArrayList1 = new ArrayList();
      mInfo.getExtras().putCharSequenceArrayList(paramString, localArrayList1);
    }
    return localArrayList1;
  }
  
  private List extrasIntList(String paramString)
  {
    if (Build.VERSION.SDK_INT < 19) {
      return new ArrayList();
    }
    ArrayList localArrayList2 = mInfo.getExtras().getIntegerArrayList(paramString);
    ArrayList localArrayList1 = localArrayList2;
    if (localArrayList2 == null)
    {
      localArrayList1 = new ArrayList();
      mInfo.getExtras().putIntegerArrayList(paramString, localArrayList1);
    }
    return localArrayList1;
  }
  ...
  private SparseArray getOrCreateSpansFromViewTags(View paramView)
  {
  ...
  private SparseArray getSpansFromViewTags(View paramView)
  {
  ...
  private int idForClickableSpan(ClickableSpan paramClickableSpan, SparseArray paramSparseArray)
  {
  ...
  public CharSequence getText()
  {
    if (hasSpans())
    {
      ...
      int j = mInfo.getText().length();
      int i = 0;
      localObject = new SpannableString(TextUtils.substring((CharSequence)localObject, 0, j));
      while (i < localList1.size())
      {
        ((Spannable)localObject).setSpan(new AccessibilityClickableSpanCompat(((Integer)localList4.get(i)).intValue(), this, getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer)localList1.get(i)).intValue(), ((Integer)localList2.get(i)).intValue(), ((Integer)localList3.get(i)).intValue());
        i += 1;
      }
      return localObject;
    }
  ...
  public void setHintText(CharSequence paramCharSequence)
  {
    if (Build.VERSION.SDK_INT >= 26)
    {
      mInfo.setHintText(paramCharSequence);
      return;
    }
    if (Build.VERSION.SDK_INT >= 19) {
  ...
  public void setPaneTitle(CharSequence paramCharSequence)
  {
    if (Build.VERSION.SDK_INT >= 28)
    {
      mInfo.setPaneTitle(paramCharSequence);
      return;
    }
    if (Build.VERSION.SDK_INT >= 19) {
  ...
  public void setScreenReaderFocusable(boolean paramBoolean)
  {
    if (Build.VERSION.SDK_INT >= 28)
    {
      mInfo.setScreenReaderFocusable(paramBoolean);
      return;
    }
  ...
  public void setShowingHintText(boolean paramBoolean)
  {
    if (Build.VERSION.SDK_INT >= 26)
    {
      mInfo.setShowingHintText(paramBoolean);
      return;
    }
  ...
  public void setTooltipText(CharSequence paramCharSequence)
  {
    if (Build.VERSION.SDK_INT >= 28)
    {
      mInfo.setTooltipText(paramCharSequence);
      return;
    }
    if (Build.VERSION.SDK_INT >= 19) {
  ...
  public static class AccessibilityActionCompat
  {
    ...
    private static final String EVENTLOG_URL = "A11yActionCompat";
    ...
    private AccessibilityActionCompat(int paramInt, CharSequence paramCharSequence, Class paramClass)
    {
    ...
    AccessibilityActionCompat(Object paramObject, int paramInt, CharSequence paramCharSequence, AccessibilityViewCommand paramAccessibilityViewCommand, Class paramClass)
    {
      alarms = paramInt;
    ...
    {
      return new AccessibilityActionCompat(null, alarms, paramCharSequence, paramAccessibilityViewCommand, mViewCommandArgumentClass);
    }
    ...
    public boolean perform(View paramView, Bundle paramBundle)
    {
      if (mCommand != null)
      {
        ...
        if (localObject4 != null)
        {
          try
          {
            localObject1 = ((Class)localObject4).getDeclaredConstructor(new Class[0]);
            localObject1 = ((Constructor)localObject1).newInstance(new Object[0]);
            localObject1 = (AccessibilityViewCommand.CommandArguments)localObject1;
            try
            {
