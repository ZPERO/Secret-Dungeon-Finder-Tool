...
{
  private static final Object getSystemService(Context paramContext)
  {
    Intrinsics.reifiedOperationMarker(4, "T");
    return ContextCompat.getSystemService(paramContext, Object.class);
  }
  
  public static final void withStyledAttributes(Context paramContext, int paramInt, int[] paramArrayOfInt, Function1 paramFunction1)
  {
  ...
  public static final void withStyledAttributes(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt, int paramInt1, int paramInt2, Function1 paramFunction1)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "$this$withStyledAttributes");
    Intrinsics.checkParameterIsNotNull(paramArrayOfInt, "attrs");
    Intrinsics.checkParameterIsNotNull(paramFunction1, "block");
