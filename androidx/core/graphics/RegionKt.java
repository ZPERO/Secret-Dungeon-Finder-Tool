...
public final class RegionKt
{
  ...
  public static final Region contains(Region paramRegion, Rect paramRect)
  {
  ...
  public static final Region contains(Region paramRegion1, Region paramRegion2)
  {
  ...
  public static final Region draw(Region paramRegion, Rect paramRect)
  {
  ...
  public static final Region draw(Region paramRegion1, Region paramRegion2)
  {
  ...
  public static final void forEach(Region paramRegion, Function1 paramFunction1)
  {
  ...
  public static final Iterator iterator(Region paramRegion)
  {
    Intrinsics.checkParameterIsNotNull(paramRegion, "$this$iterator");
    (Iterator)new Iterator()
    {
      private boolean hasMore = iterator.next(rect);
      private final RegionIterator iterator = new RegionIterator(RegionKt.this);
  ...
  public static final Region union(Region paramRegion, Rect paramRect)
  {
  ...
  public static final Region union(Region paramRegion1, Region paramRegion2)
  {
