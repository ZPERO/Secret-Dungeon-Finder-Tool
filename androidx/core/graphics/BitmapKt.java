...
{
  public static final Bitmap applyCanvas(Bitmap paramBitmap, Function1 paramFunction1)
  {
  ...
  public static final boolean contains(Bitmap paramBitmap, PointF paramPointF)
  {
    ...
    return (x >= 0.0F) && (x < paramBitmap.getWidth()) && (y >= 0.0F) && (y < paramBitmap.getHeight());
  }
  ...
  public static final void draw(Bitmap paramBitmap, int paramInt1, int paramInt2, int paramInt3)
  {
