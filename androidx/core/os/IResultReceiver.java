  ...
  extends IInterface
{
    ...
    implements IResultReceiver
  {
    ...
    public static IResultReceiver asInterface(IBinder paramIBinder)
    {
      ...
      IInterface localIInterface = paramIBinder.queryLocalInterface("androidx.core.os.IResultReceiver");
      ...
      throws RemoteException
    {
      if (paramInt1 != 1)
      {
        ...
        paramParcel2.writeString("androidx.core.os.IResultReceiver");
        return true;
      }
      paramParcel1.enforceInterface("androidx.core.os.IResultReceiver");
      ...
      implements IResultReceiver
    {
      ...
      {
        return "androidx.core.os.IResultReceiver";
      }
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel.writeInterfaceToken("androidx.core.os.IResultReceiver");
