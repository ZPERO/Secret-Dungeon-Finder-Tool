...
public final class LinkifyCompat
{
  ...
  private static void gatherMapLinks(ArrayList paramArrayList, Spannable paramSpannable)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 267	java/lang/Object:toString	()Ljava/lang/String;
    //   4: astore_1
    //   5: iconst_0
    //   6: istore_2
    //   7: aload_1
    //   8: invokestatic 268	androidx/core/text/util/LinkifyCompat:findAddress	(Ljava/lang/String;)Ljava/lang/String;
    //   11: astore 6
    //   13: aload 6
    //   15: ifnull +123 -> 138
    //   18: aload_1
    //   19: aload 6
    //   21: invokevirtual 272	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   24: istore_3
    //   25: iload_3
    //   26: ifge +4 -> 30
    //   29: return
    //   30: new 8	androidx/core/text/util/LinkifyCompat$LinkSpec
    //   33: dup
    //   34: invokespecial 255	androidx/core/text/util/LinkifyCompat$LinkSpec:<init>	()V
    //   37: astore 5
    //   39: aload 6
    //   41: invokevirtual 273	java/lang/String:length	()I
    //   44: istore 4
    //   46: iload 4
    //   48: iload_3
    //   49: iadd
    ...
    //   55: iload_2
    //   56: iadd
    //   57: putfield 174	androidx/core/text/util/LinkifyCompat$LinkSpec:start	I
    //   60: iload_2
    //   61: iload 4
    //   63: iadd
    //   64: istore_2
    //   65: aload 5
    //   67: iload_2
    //   68: putfield 177	androidx/core/text/util/LinkifyCompat$LinkSpec:end	I
    //   71: aload_1
    //   72: iload 4
    ...
    //   78: aload 6
    //   80: ldc_w 278
    //   83: invokestatic 284	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   86: astore 6
    //   88: new 286	java/lang/StringBuilder
    //   91: dup
    //   92: invokespecial 287	java/lang/StringBuilder:<init>	()V
    //   95: astore 7
    //   97: aload 7
    //   99: ldc_w 289
    //   102: invokevirtual 293	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   105: pop
    //   106: aload 7
    //   108: aload 6
    //   110: invokevirtual 293	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   113: pop
    //   114: aload 7
    //   116: invokevirtual 294	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   119: astore 6
    //   121: aload 5
    //   123: aload 6
    //   125: putfield 170	androidx/core/text/util/LinkifyCompat$LinkSpec:url	Ljava/lang/String;
    //   128: aload_0
    //   129: aload 5
    //   131: invokevirtual 259	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   134: pop
    //   135: goto -128 -> 7
    //   138: return
    //   139: astore_0
