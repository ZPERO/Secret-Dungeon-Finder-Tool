...
public class NotificationCompat
{
  ...
  public class Action
  {
    ...
    Action(CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput1, RemoteInput[] paramArrayOfRemoteInput2, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
    {
      icon = this$1;
    ...
    public final class Builder
    {
      ...
      private ArrayList<androidx.core.app.RemoteInput> mRemoteInputs;
      ...
      private Builder(CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
      {
        mIcon = this$1;
  ...
  public class Builder
  {
    ...
    public ArrayList<androidx.core.app.NotificationCompat.Action> mActions = new ArrayList();
    int mBadgeIcon = 0;
    ...
    ArrayList<androidx.core.app.NotificationCompat.Action> mInvisibleActions = new ArrayList();
    Bitmap mLargeIcon;
    ...
    public Builder setLights(int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      ledOnMS = paramInt2;
      ledOffMS = paramInt3;
      if ((ledOnMS != 0) && (mNotification.ledOffMS != 0)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
    ...
    extends NotificationCompat.Style
  {
    ...
    private final List<androidx.core.app.NotificationCompat.MessagingStyle.Message> mMessages = new ArrayList();
    ...
    private Message findLatestIncomingMessage()
    {
      ...
      while (i >= 0)
      {
        localObject = (Message)mMessages.get(i);
    ...
    {
      if ((mBuilder != null) && (mBuilder.mContext.getApplicationInfo().targetSdkVersion < 28) && (mIsGroupConversation == null))
      {
        if (mConversationTitle != null) {
          return true;
        }
    ...
    implements NotificationCompat.Extender
  {
    ...
    private ArrayList<androidx.core.app.NotificationCompat.Action> mActions = new ArrayList();
