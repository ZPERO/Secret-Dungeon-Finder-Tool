...
public final class ShareCompat
{
  ...
  public static ComponentName getCallingActivity(Activity paramActivity)
  {
    ...
    if (localComponentName2 == null)
    {
      ...
      if (localComponentName2 == null) {
        localComponentName1 = (ComponentName)paramActivity.getIntent().getParcelableExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY");
      }
    }
  ...
  public class IntentBuilder
  {
    ...
    {
      mIntent.putExtra("androidx.core.app.EXTRA_CALLING_PACKAGE", getPackageName());
      mIntent.putExtra("androidx.core.app.EXTRA_CALLING_PACKAGE", getPackageName());
      mIntent.putExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY", getComponentName());
      mIntent.putExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY", getComponentName());
