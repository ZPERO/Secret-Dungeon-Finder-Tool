  ...
  implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView
{
  ...
  public void computeScroll()
  {
    ...
    if (j != 0)
    {
      ...
      arrayOfInt[1] = 0;
      dispatchNestedScroll(0, i, 0, j, mScrollOffset, 1, arrayOfInt);
  ...
  {
    throw new Error("Unresolved compilation error: Method <androidx.core.widget.NestedScrollView: boolean getClipToPadding()> does not exist!");
  }
        ...
        else
        {
          ...
          else
          {
            ...
            if (mIsBeingDragged)
            {
              ...
              localObject[1] = 0;
              dispatchNestedScroll(0, i1, 0, i - i1, mScrollOffset, 0, (int[])localObject);
              i1 = mLastMotionY;
              localObject = mScrollOffset;
              mLastMotionY = (i1 - localObject[1]);
