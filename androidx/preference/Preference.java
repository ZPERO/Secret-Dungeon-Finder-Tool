  ...
  implements Comparable<Preference>
{
  ...
  public Set getPersistedStringSet(Set paramSet)
  {
    if (!shouldPersist()) {
      return paramSet;
    }
  ...
  protected void onAttachedToHierarchy(PreferenceManager paramPreferenceManager, long paramLong)
  {
    ...
    catch (Throwable paramPreferenceManager)
    {
      mHasId = false;
      throw paramPreferenceManager;
    }
  }
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    if (paramParcelable != AbsSavedState.EMPTY_STATE)
    {
  ...
  public boolean persistStringSet(Set paramSet)
  {
    if (!shouldPersist()) {
      return false;
    }
  ...
  {
    public abstract CharSequence provideSummary(Preference paramPreference);
  }
}
