  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  {
    throw new Error("Unresolved compilation error: Method <androidx.appcompat.widget.ActivityChooserView: void saveAttributeDataForStyleable(android.content.Context,int[],android.util.AttributeSet,android.content.res.TypedArray,int,int)> does not exist!");
  }
