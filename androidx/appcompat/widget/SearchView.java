  ...
  implements CollapsibleActionView
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      ...
      UpdatableTouchDelegate localUpdatableTouchDelegate = mTouchDelegate;
      ...
      localUpdatableTouchDelegate.setBounds(mSearchSrtTextViewBoundsExpanded, mSearchSrcTextViewBounds);
    }
  }
    ...
    extends AppCompatAutoCompleteTextView
  {
    ...
    {
      throw new Error("Unresolved compilation error: Method <androidx.appcompat.widget.SearchView$SearchAutoComplete: void refreshAutoCompleteResults()> does not exist!");
    }
