package androidx.media.routing;
...
import androidx.core.package_7.NotificationBuilderWithBuilderAccessor;
import androidx.core.package_7.NotificationCompat.Action;
import androidx.core.package_7.NotificationCompat.Builder;
import androidx.core.package_7.NotificationCompat.Style;
...
public class NotificationCompat
{
    ...
    extends NotificationCompat.MediaStyle
  {
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      ...
      {
        paramNotificationBuilderWithBuilderAccessor.getBuilder().setStyle((Notification.Style)fillInMediaStyle(new Notification.DecoratedMediaCustomViewStyle()));
        return;
      }
    ...
    extends NotificationCompat.Style
  {
    ...
    {
      paramNotification = androidx.core.package_7.NotificationCompat.getExtras(paramNotification);
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      if (Build.VERSION.SDK_INT >= 21)
      {
        paramNotificationBuilderWithBuilderAccessor.getBuilder().setStyle((Notification.Style)fillInMediaStyle(new Notification.MediaStyle()));
        return;
      }
    ...
    RemoteViews generateContentView()
    {
      ...
      if (i > 0)
      {
        ...
        while (j < i) {
          if (j < k)
          {
            localObject = generateMediaActionButton((NotificationCompat.Action)mBuilder.mActions.get(mActionsToShowInCompact[j]));
            localRemoteViews.addView(R.id.media_actions, (RemoteViews)localObject);
            j += 1;
          }
          else
