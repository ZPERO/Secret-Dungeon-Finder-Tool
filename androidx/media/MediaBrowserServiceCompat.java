...
import androidx.core.package_7.BundleCompat;
    ...
    implements MediaBrowserServiceCompat.MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy
  {
    ...
    public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String paramString, int paramInt, Bundle paramBundle)
    {
      ...
      if ((paramBundle != null) && (paramBundle.getInt("extra_client_version", 0) != 0))
      {
        ...
        BundleCompat.putBinder((Bundle)localObject2, "extra_messenger", mMessenger.getBinder());
        if (mSession != null)
        {
          localObject1 = mSession.getExtraBinder();
          if (localObject1 == null) {
            localObject1 = null;
          } else {
            localObject1 = ((IInterface)localObject1).asBinder();
          }
          BundleCompat.putBinder((Bundle)localObject2, "extra_session_binder", (IBinder)localObject1);
          localObject1 = localObject2;
        }
        else
        {
          mRootExtrasList.add(localObject2);
          localObject1 = localObject2;
        }
      }
      else
      ...
      mCurConnection = new MediaBrowserServiceCompat.ConnectionRecord((MediaBrowserServiceCompat)localObject2, paramString, -1, paramInt, paramBundle, null);
    ...
    extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      case 9: 
        ...
        mServiceBinderImpl.sendCustomAction(((Bundle)localObject).getString("data_custom_action"), localBundle, (ResultReceiver)((Bundle)localObject).getParcelable("data_result_receiver"), new MediaBrowserServiceCompat.ServiceCallbacksCompat(replyTo));
        return;
      case 8: 
        localBundle = ((Bundle)localObject).getBundle("data_search_extras");
        MediaSessionCompat.ensureClassLoader(localBundle);
        mServiceBinderImpl.search(((Bundle)localObject).getString("data_search_query"), localBundle, (ResultReceiver)((Bundle)localObject).getParcelable("data_result_receiver"), new MediaBrowserServiceCompat.ServiceCallbacksCompat(replyTo));
        return;
      case 7: 
      ...
      case 6: 
        ...
        MediaSessionCompat.ensureClassLoader(localBundle);
        mServiceBinderImpl.registerCallbacks(new MediaBrowserServiceCompat.ServiceCallbacksCompat(replyTo), ((Bundle)localObject).getString("data_package_name"), ((Bundle)localObject).getInt("data_calling_pid"), ((Bundle)localObject).getInt("data_calling_uid"), localBundle);
        return;
      case 5: 
      ...
      case 3: 
        ...
        MediaSessionCompat.ensureClassLoader(localBundle);
        mServiceBinderImpl.addSubscription(((Bundle)localObject).getString("data_media_item_id"), BundleCompat.getBinder((Bundle)localObject, "data_callback_token"), localBundle, new MediaBrowserServiceCompat.ServiceCallbacksCompat(replyTo));
        return;
      case 2: 
      ...
      MediaSessionCompat.ensureClassLoader(localBundle);
      mServiceBinderImpl.connect(((Bundle)localObject).getString("data_package_name"), ((Bundle)localObject).getInt("data_calling_pid"), ((Bundle)localObject).getInt("data_calling_uid"), localBundle, new MediaBrowserServiceCompat.ServiceCallbacksCompat(replyTo));
    }
