...
public class DiffUtil
{
  ...
  public static class DiffResult
  {
    ...
    public int convertNewPositionToOld(int paramInt)
    {
      ...
      ((StringBuilder)localObject).append("Index out of bounds - passed position = ");
      ((StringBuilder)localObject).append(paramInt);
      ((StringBuilder)localObject).append(", new list size = ");
    ...
    public int convertOldPositionToNew(int paramInt)
    {
      ...
      ((StringBuilder)localObject).append("Index out of bounds - passed position = ");
      ((StringBuilder)localObject).append(paramInt);
      ((StringBuilder)localObject).append(", old list size = ");
