  ...
  extends FrameLayout
{
  ...
  private final CardViewDelegate mCardViewDelegate = new CardViewDelegate()
  {
    ...
    public void setShadowPadding(int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3, int paramAnonymousInt4)
    {
      ...
      localCardView.setPadding(paramAnonymousInt1 + mContentPadding.left, paramAnonymousInt2 + mContentPadding.top, paramAnonymousInt3 + mContentPadding.right, paramAnonymousInt4 + mContentPadding.bottom);
    }
  };
