...
import androidx.core.content.delay.ComplexColorCompat;
  ...
  extends VectorDrawableCommon
{
  ...
  private void printGroupTree(VGroup paramVGroup, int paramInt)
  {
    ...
    {
      localObject = (VObject)mChildren.get(i);
  ...
  {
    VectorDrawableCompatState localVectorDrawableCompatState = mVectorState;
    if ((localVectorDrawableCompatState != null) && (mVPathRenderer != null) && (mVectorState.mVPathRenderer.mBaseWidth != 0.0F) && (mVectorState.mVPathRenderer.mBaseHeight != 0.0F) && (mVectorState.mVPathRenderer.mViewportHeight != 0.0F) && (mVectorState.mVPathRenderer.mViewportWidth != 0.0F))
    {
  ...
  public boolean isStateful()
  {
    ...
    {
      VectorDrawableCompatState localVectorDrawableCompatState = mVectorState;
      if ((localVectorDrawableCompatState == null) || ((!localVectorDrawableCompatState.isStateful()) && ((mVectorState.mTint == null) || (!mVectorState.mTint.isStateful())))) {
        return false;
      }
    }
    return true;
  ...
  protected boolean onStateChange(int[] paramArrayOfInt)
  {
    ...
    if ((localVectorDrawableCompatState.isStateful()) && (localVectorDrawableCompatState.onStateChanged(paramArrayOfInt)))
    {
      invalidateSelf();
      return true;
    }
    ...
    private void drawPath(VectorDrawableCompat.VGroup paramVGroup, VectorDrawableCompat.VPath paramVPath, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      if (mFillColor.willDraw())
      {
        ...
        if (paramVGroup.isGradient())
        {
          ...
          ((Paint)localObject).setAlpha(Math.round(mFillAlpha * 255.0F));
        }
        else
        {
          ((Paint)localObject).setShader(null);
          ((Paint)localObject).setAlpha(255);
          ((Paint)localObject).setColor(VectorDrawableCompat.applyAlpha(paramVGroup.getColor(), mFillAlpha));
        }
      ...
      if (mStrokeColor.willDraw())
      {
        ...
        if (((ComplexColorCompat)localObject).isGradient())
        {
          ...
          ((Shader)localObject).setLocalMatrix(mFinalPathMatrix);
        ...
        else
        {
          ...
          paramVGroup.setColor(VectorDrawableCompat.applyAlpha(((ComplexColorCompat)localObject).getColor(), mStrokeAlpha));
        }
    ...
    public VectorDrawableCompatState(VectorDrawableCompatState paramVectorDrawableCompatState)
    {
      if (paramVectorDrawableCompatState != null)
      {
        ...
        if (mVPathRenderer.mFillPaint != null) {
          mVPathRenderer.mFillPaint = new Paint(mVPathRenderer.mFillPaint);
        }
