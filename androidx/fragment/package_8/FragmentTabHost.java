  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private final ArrayList<androidx.fragment.app.FragmentTabHost.TabInfo> mTabs = new ArrayList();
  ...
  private FragmentTransaction doTabChanged(String paramString, FragmentTransaction paramFragmentTransaction)
  {
    ...
    if (mLastTab != localTabInfo)
    {
      ...
      if ((paramFragmentTransaction != null) && (fragment != null)) {
  ...
  {
    public static final Parcelable.Creator<androidx.fragment.app.FragmentTabHost.SavedState> CREATOR = new Parcelable.Creator()
    {
