...
public class Reflection
{
  ...
  static
  {
    ...
    try
    {
      Object localObject2 = Class.forName("kotlin.reflect.jvm.internal.ReflectionFactoryImpl").newInstance();
      localObject2 = (ReflectionFactory)localObject2;
    ...
    if (localObject1 == null) {
      localObject1 = new ReflectionFactory();
    }
    factory = (ReflectionFactory)localObject1;
  }
  ...
  {
    return factory.typeOf(getOrCreateKotlinClass(paramClass), ArraysKt___ArraysKt.toList(paramVarArgs), true);
  }
  ...
  {
    return factory.typeOf(getOrCreateKotlinClass(paramClass), ArraysKt___ArraysKt.toList(paramVarArgs), false);
  }
}
