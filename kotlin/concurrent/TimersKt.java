...
{
  private static final Timer fixedRateTimer(String paramString, boolean paramBoolean, long paramLong1, long paramLong2, Function1 paramFunction1)
  {
  ...
  private static final Timer fixedRateTimer(String paramString, boolean paramBoolean, Date paramDate, long paramLong, Function1 paramFunction1)
  {
    paramString = timer(paramString, paramBoolean);
    paramString.scheduleAtFixedRate((TimerTask)new TimerTask()
    {
  ...
  private static final TimerTask schedule(Timer paramTimer, long paramLong1, long paramLong2, Function1 paramFunction1)
  {
  ...
  private static final TimerTask schedule(Timer paramTimer, long paramLong, Function1 paramFunction1)
  {
    paramFunction1 = (TimerTask)new TimerTask()
    {
      public void run()
  ...
  private static final TimerTask schedule(Timer paramTimer, Date paramDate, long paramLong, Function1 paramFunction1)
  {
    paramFunction1 = (TimerTask)new TimerTask()
    {
      public void run()
  ...
  private static final TimerTask schedule(Timer paramTimer, Date paramDate, Function1 paramFunction1)
  {
    paramFunction1 = (TimerTask)new TimerTask()
    {
      public void run()
  ...
  private static final TimerTask scheduleAtFixedRate(Timer paramTimer, long paramLong1, long paramLong2, Function1 paramFunction1)
  {
    paramFunction1 = (TimerTask)new TimerTask()
    {
      public void run()
  ...
  private static final TimerTask scheduleAtFixedRate(Timer paramTimer, Date paramDate, long paramLong, Function1 paramFunction1)
  {
    paramFunction1 = (TimerTask)new TimerTask()
    {
      public void run()
  ...
  private static final Timer timer(String paramString, boolean paramBoolean, long paramLong1, long paramLong2, Function1 paramFunction1)
  {
    paramString = timer(paramString, paramBoolean);
  ...
  private static final Timer timer(String paramString, boolean paramBoolean, Date paramDate, long paramLong, Function1 paramFunction1)
  {
    paramString = timer(paramString, paramBoolean);
    paramString.schedule((TimerTask)new TimerTask()
    {
  ...
  private static final TimerTask timerTask(Function1 paramFunction1)
  {
