...
{
  public static final double measureTime(Function0 paramFunction0)
  {
  ...
  public static final double measureTime(Clock paramClock, Function0 paramFunction0)
  {
  ...
  public static final TimedValue measureTimedValue(Function0 paramFunction0)
  {
    Intrinsics.checkParameterIsNotNull(paramFunction0, "block");
    ClockMark localClockMark = ((Clock)MonoClock.INSTANCE).markNow();
  ...
  public static final TimedValue measureTimedValue(Clock paramClock, Function0 paramFunction0)
  {
