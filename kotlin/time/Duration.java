  ...
  implements Comparable<Duration>
{
  ...
  public static final Object toComponents-impl(double paramDouble, Function2 paramFunction2)
  {
  ...
  public static final Object toComponents-impl(double paramDouble, Function3 paramFunction3)
  {
  ...
  public static final Object toComponents-impl(double paramDouble, Function4 paramFunction4)
  {
  ...
  public static final Object toComponents-impl(double paramDouble, Function5 paramFunction5)
  {
  ...
  public static final double toDouble-impl(double paramDouble, TimeUnit paramTimeUnit)
  {
    ...
    return DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(paramDouble, DurationKt.access$getStorageUnit$p(), paramTimeUnit);
  }
  ...
  public static final String toIsoString-impl(double paramDouble)
  {
    ...
    if ((j != 0) || ((i == 0) && (k == 0)))
    {
      ...
      {
        ((StringBuilder)localObject).append('.');
        String str = StringsKt__StringsKt.padStart(String.valueOf(i3), 9, '0');
        if (i3 % 1000000 == 0) {
  ...
  public static String toString-impl(double paramDouble)
  {
    ...
    localStringBuilder.append(DurationUnitKt__DurationUnitKt.shortName(localTimeUnit));
  ...
  public static final String toString-impl(double paramDouble, TimeUnit paramTimeUnit, int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      if (Math.abs(paramDouble) < 1.0E14D) {
        str = FormatToDecimalsKt.formatToExactDecimals(paramDouble, RangesKt___RangesKt.coerceAtMost(paramInt, 12));
      } else {
        str = FormatToDecimalsKt.formatScientific(paramDouble);
      }
      localStringBuilder.append(str);
      localStringBuilder.append(DurationUnitKt__DurationUnitKt.shortName(paramTimeUnit));
      return localStringBuilder.toString();
    }
  ...
  {
    return compareTo-LRDsOJo(value, paramDouble);
  }
  ...
  public static final class Companion
  {
    ...
    public final double convert(double paramDouble, TimeUnit paramTimeUnit1, TimeUnit paramTimeUnit2)
    {
      ...
      return DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(paramDouble, paramTimeUnit1, paramTimeUnit2);
    }
