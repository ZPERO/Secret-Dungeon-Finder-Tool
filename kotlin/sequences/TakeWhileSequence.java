  ...
  implements Sequence<T>
{
  ...
  public TakeWhileSequence(Sequence paramSequence, Function1 paramFunction1)
  {
  ...
  public Iterator iterator()
  {
    ...
    {
      private final Iterator<T> iterator = TakeWhileSequence.access$getSequence$p(TakeWhileSequence.this).iterator();
      private T nextItem;
      ...
      private final void calcNext()
      {
        if (iterator.hasNext())
        {
          ...
          if (((Boolean)TakeWhileSequence.access$getPredicate$p(TakeWhileSequence.this).invoke(localObject)).booleanValue())
          {
            nextState = 1;
