...
class USequencesKt___USequencesKt
{
  ...
  public static final int sumOfUByte(Sequence paramSequence)
  {
  ...
  public static final int sumOfUInt(Sequence paramSequence)
  {
    Intrinsics.checkParameterIsNotNull(paramSequence, "$this$sum");
    paramSequence = paramSequence.iterator();
  ...
  public static final long sumOfULong(Sequence paramSequence)
  {
    Intrinsics.checkParameterIsNotNull(paramSequence, "$this$sum");
    paramSequence = paramSequence.iterator();
  ...
  public static final int sumOfUShort(Sequence paramSequence)
  {
    Intrinsics.checkParameterIsNotNull(paramSequence, "$this$sum");
    paramSequence = paramSequence.iterator();
