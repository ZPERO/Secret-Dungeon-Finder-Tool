  ...
  implements Sequence<T>, DropTakeSequence<T>
{
  ...
  public TakeSequence(Sequence paramSequence, int paramInt)
  {
  ...
  public Sequence drop(int paramInt)
  {
    ...
    return (Sequence)new SubSequence(sequence, paramInt, i);
  }
  ...
  public Iterator iterator()
  {
    ...
    {
      private final Iterator<T> iterator = TakeSequence.access$getSequence$p(TakeSequence.this).iterator();
      private int left = TakeSequence.access$getCount$p(TakeSequence.this);
