  ...
  extends SequencesKt__SequencesKt
{
  ...
  public static final Sequence filterIsInstance(Sequence paramSequence, Class paramClass)
  {
    ...
    paramSequence = SequencesKt___SequencesKt.filter(paramSequence, (Function1)new Lambda(paramClass)
    {
      public final boolean invoke(Object paramAnonymousObject)
      {
        return isInstance(paramAnonymousObject);
      }
    });
  ...
  public static final Collection filterIsInstanceTo(Sequence paramSequence, Collection paramCollection, Class paramClass)
  {
  ...
  public static final SortedSet toSortedSet(Sequence paramSequence)
  {
    Intrinsics.checkParameterIsNotNull(paramSequence, "$this$toSortedSet");
    return (SortedSet)SequencesKt___SequencesKt.toCollection(paramSequence, (Collection)new TreeSet());
  }
  
  public static final SortedSet toSortedSet(Sequence paramSequence, Comparator paramComparator)
  {
    Intrinsics.checkParameterIsNotNull(paramSequence, "$this$toSortedSet");
    Intrinsics.checkParameterIsNotNull(paramComparator, "comparator");
    return (SortedSet)SequencesKt___SequencesKt.toCollection(paramSequence, (Collection)new TreeSet(paramComparator));
  }
}
