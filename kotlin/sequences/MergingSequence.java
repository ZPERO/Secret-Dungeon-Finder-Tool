  ...
  implements Sequence<V>
{
  ...
  public MergingSequence(Sequence paramSequence1, Sequence paramSequence2, Function2 paramFunction2)
  {
    sequence1 = paramSequence1;
    sequence2 = paramSequence2;
  ...
  public Iterator iterator()
  {
    ...
    {
      private final Iterator<T1> iterator1 = MergingSequence.access$getSequence1$p(MergingSequence.this).iterator();
      private final Iterator<T2> iterator2 = MergingSequence.access$getSequence2$p(MergingSequence.this).iterator();
      ...
      public Object next()
      {
        return MergingSequence.access$getTransform$p(MergingSequence.this).invoke(iterator1.next(), iterator2.next());
      }
