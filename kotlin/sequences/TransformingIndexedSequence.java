  ...
  implements Sequence<R>
{
  ...
  public TransformingIndexedSequence(Sequence paramSequence, Function2 paramFunction2)
  {
  ...
  public Iterator iterator()
  {
    ...
    {
      private int index;
      private final Iterator<T> iterator = TransformingIndexedSequence.access$getSequence$p(TransformingIndexedSequence.this).iterator();
      ...
      public Object next()
      {
        Function2 localFunction2 = TransformingIndexedSequence.access$getTransformer$p(TransformingIndexedSequence.this);
        int i = index;
        index = (i + 1);
        if (i < 0) {
