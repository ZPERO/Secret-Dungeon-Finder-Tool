  ...
  implements Sequence<R>
{
  ...
  public TransformingSequence(Sequence paramSequence, Function1 paramFunction1)
  {
    sequence = paramSequence;
    transformer = paramFunction1;
  }
  
  public final Sequence flatten$kotlin_stdlib(Function1 paramFunction1)
  {
  ...
  public Iterator iterator()
  {
    ...
    {
      private final Iterator<T> iterator = TransformingSequence.access$getSequence$p(TransformingSequence.this).iterator();
      ...
      public Object next()
      {
        return TransformingSequence.access$getTransformer$p(TransformingSequence.this).invoke(iterator.next());
      }
