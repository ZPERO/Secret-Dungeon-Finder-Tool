  ...
  implements Sequence<E>
{
  ...
  public FlatteningSequence(Sequence paramSequence, Function1 paramFunction11, Function1 paramFunction12)
  {
    sequence = paramSequence;
    transformer = paramFunction11;
    iterator = paramFunction12;
  }
  ...
  public Iterator iterator()
  {
    (Iterator)new Iterator()
    {
      ...
      private final Iterator<T> iterator = FlatteningSequence.access$getSequence$p(FlatteningSequence.this).iterator();
      ...
      private final boolean ensureItemIterator()
      {
        ...
        while (itemIterator == null)
        {
          ...
          localObject = (Iterator)FlatteningSequence.access$getIterator$p(FlatteningSequence.this).invoke(FlatteningSequence.access$getTransformer$p(FlatteningSequence.this).invoke(localObject));
      ...
      public final void setItemIterator(Iterator paramAnonymousIterator)
      {
