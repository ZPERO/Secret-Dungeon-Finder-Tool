...
{
  public abstract Object fold(Object paramObject, Function2 paramFunction2);
  ...
  public abstract Element remove(Key paramKey);
    ...
    extends CoroutineContext
  {
    ...
    public abstract Element remove(CoroutineContext.Key paramKey);
    
    @Metadata(bv={1, 0, 3}, k=3, mv={1, 1, 15})
    public static final class DefaultImpls
    {
      public static Object fold(CoroutineContext.Element paramElement, Object paramObject, Function2 paramFunction2)
      {
        Intrinsics.checkParameterIsNotNull(paramFunction2, "operation");
        return paramFunction2.invoke(paramObject, paramElement);
      }
      
      public static CoroutineContext.Element getValue(CoroutineContext.Element paramElement, CoroutineContext.Key paramKey)
      {
      ...
      public static CoroutineContext minusKey(CoroutineContext.Element paramElement, CoroutineContext.Key paramKey)
      {
        ...
        if (Intrinsics.areEqual(((CoroutineContext.Element)paramElement).getKey(), paramKey)) {
  ...
  @Metadata(bv={1, 0, 3}, d1={"\000\020\n\002\030\002\n\000\n\002\030\002\n\002\020\000\n\000\bf\030\000*\b\b\000\020\001*\0020\0022\0020\003?\006\004"}, d2={"Lkotlin/coroutines/CoroutineContext$Key;", "E", "Lkotlin/coroutines/CoroutineContext$Element;", "", "kotlin-stdlib"}, k=1, mv={1, 1, 15})
