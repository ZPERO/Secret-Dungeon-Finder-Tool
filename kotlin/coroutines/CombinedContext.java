  ...
  implements CoroutineContext, Serializable
{
  ...
  {
    return Intrinsics.areEqual(remove(paramElement.getKey()), paramElement);
  }
  ...
  private final int size()
  {
    ...
    for (;;)
    {
      CoroutineContext localCoroutineContext = left;
  ...
  private final Object writeReplace()
  {
    ...
    fold(Unit.INSTANCE, (Function2)new Lambda(arrayOfCoroutineContext)
    {
      public final void invoke(Unit paramAnonymousUnit, CoroutineContext.Element paramAnonymousElement)
      {
        ...
        paramAnonymousUnit = CombinedContext.this;
  ...
  public Object fold(Object paramObject, Function2 paramFunction2)
  {
    ...
    return paramFunction2.invoke(left.fold(paramObject, paramFunction2), element);
  }
  ...
  public CoroutineContext minusKey(CoroutineContext.Key paramKey)
  {
    ...
    if (element.remove(paramKey) != null) {
      return left;
    }
  ...
  public CoroutineContext.Element remove(CoroutineContext.Key paramKey)
  {
    ...
    {
      CoroutineContext.Element localElement = element.remove(paramKey);
    ...
    return ((CoroutineContext)localObject).remove(paramKey);
  }
    ...
    implements Serializable
  {
    ...
    {
      elements = paramArrayOfCoroutineContext;
    }
    
    private final Object readResolve()
    {
      CoroutineContext[] arrayOfCoroutineContext = elements;
