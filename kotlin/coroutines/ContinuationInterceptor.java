  ...
  extends CoroutineContext.Element
{
  ...
  public abstract CoroutineContext.Element remove(CoroutineContext.Key paramKey);
  ...
  public static final class DefaultImpls
  {
    ...
    public static CoroutineContext.Element getValue(ContinuationInterceptor paramContinuationInterceptor, CoroutineContext.Key paramKey)
    {
      Intrinsics.checkParameterIsNotNull(paramKey, "key");
      if (paramKey == ContinuationInterceptor.this$0)
      {
