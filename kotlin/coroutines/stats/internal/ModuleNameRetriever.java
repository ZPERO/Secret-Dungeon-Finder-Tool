...
final class ModuleNameRetriever
{
  ...
  private final Cache buildCache(BaseContinuationImpl paramBaseContinuationImpl)
  {
    try
    {
      Method localMethod = Class.class.getDeclaredMethod("getModule", new Class[0]);
      Object localObject = paramBaseContinuationImpl.getClass().getClassLoader().loadClass("java.lang.Module");
      localObject = ((Class)localObject).getDeclaredMethod("getDescriptor", new Class[0]);
      paramBaseContinuationImpl = paramBaseContinuationImpl.getClass().getClassLoader().loadClass("java.lang.module.ModuleDescriptor");
      paramBaseContinuationImpl = paramBaseContinuationImpl.getDeclaredMethod("name", new Class[0]);
      paramBaseContinuationImpl = new Cache(localMethod, (Method)localObject, paramBaseContinuationImpl);
  ...
  final class Cache
  {
    ...
    {
      getDescriptorMethod = paramMethod1;
      nameMethod = paramMethod2;
    }
  }
}
