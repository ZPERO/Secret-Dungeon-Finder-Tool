...
public final class DebugMetadataKt
{
  ...
  {
    return (DebugMetadata)paramBaseContinuationImpl.getClass().getAnnotation(kotlin.coroutines.jvm.internal.DebugMetadata.class);
  }
  ...
  public static final String[] getSpilledVariableFieldMapping(BaseContinuationImpl paramBaseContinuationImpl)
  {
    ...
    {
      checkDebugMetadataVersion(1, localDebugMetadata.getLineStartOffset());
      ArrayList localArrayList = new ArrayList();
      int j = getLabel(paramBaseContinuationImpl);
      paramBaseContinuationImpl = localDebugMetadata.calculateLength();
      ...
      while (i < k)
      {
        ...
        {
          localArrayList.add(localDebugMetadata.getServerList()[i]);
          localArrayList.add(localDebugMetadata.getChannelList()[i]);
        }
        i += 1;
      }
  ...
  public static final StackTraceElement getStackTraceElement(BaseContinuationImpl paramBaseContinuationImpl)
  {
    ...
    if (localDebugMetadata != null)
    {
      ...
      if (i < 0) {
        ...
        i = localDebugMetadata.getYCoordinates()[i];
      }
      paramBaseContinuationImpl = ModuleNameRetriever.INSTANCE.getModuleName(paramBaseContinuationImpl);
      if (paramBaseContinuationImpl == null)
      {
        paramBaseContinuationImpl = localDebugMetadata.getCovalentRadius();
      }
      else
      {
        StringBuilder localStringBuilder = new StringBuilder();
        ...
        localStringBuilder.append(localDebugMetadata.getCovalentRadius());
        paramBaseContinuationImpl = localStringBuilder.toString();
      }
      return new StackTraceElement(paramBaseContinuationImpl, localDebugMetadata.getGUID(), localDebugMetadata.getAndClear(), i);
    }
    return null;
  }
}
