...
public abstract class BaseContinuationImpl
  implements Continuation<Object>, kotlin.coroutines.jvm.internal.CoroutineStackFrame, Serializable
{
  private final Continuation<Object> completion;
  
  public BaseContinuationImpl(Continuation paramContinuation)
  {
  ...
  {
    Continuation localContinuation2 = completion;
  ...
  public final void resumeWith(Object paramObject)
  {
    ...
    for (BaseContinuationImpl localBaseContinuationImpl = (BaseContinuationImpl)this;; localBaseContinuationImpl = (BaseContinuationImpl)localContinuation)
    {
      ...
      try
      {
        ...
        localObject = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
  ...
  public String toString()
  {
    ...
    StackTraceElement localStackTraceElement = getStackTraceElement();
    Object localObject = localStackTraceElement;
