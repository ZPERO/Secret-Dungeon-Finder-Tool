...
public final class SafeContinuation<T>
  implements Continuation<T>, kotlin.coroutines.jvm.internal.CoroutineStackFrame
{
  @Deprecated
  ...
  public SafeContinuation(Continuation paramContinuation)
  {
    this(paramContinuation, CoroutineSingletons.UNDECIDED);
  }
  
  public SafeContinuation(Continuation paramContinuation, Object paramObject)
  {
    delegate = paramContinuation;
    result = paramObject;
  }
  
  public kotlin.coroutines.stats.internal.CoroutineStackFrame getCallerFrame()
  {
    Continuation localContinuation2 = delegate;
    Continuation localContinuation1 = localContinuation2;
    if (!(localContinuation2 instanceof kotlin.coroutines.stats.internal.CoroutineStackFrame)) {
      localContinuation1 = null;
    }
    return (kotlin.coroutines.stats.internal.CoroutineStackFrame)localContinuation1;
  }
  ...
  public void resumeWith(Object paramObject)
  {
    do
    {
      ...
      return;
      if (localObject != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        break;
      }
    } while (!RESULT.compareAndSet(this, IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED));
