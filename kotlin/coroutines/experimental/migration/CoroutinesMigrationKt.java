...
{
  public static final kotlin.coroutines.Continuation toContinuation(kotlin.coroutines.experimental.Continuation paramContinuation)
  {
  ...
  public static final kotlin.coroutines.CoroutineContext toCoroutineContext(kotlin.coroutines.experimental.CoroutineContext paramCoroutineContext)
  {
    ...
    kotlin.coroutines.experimental.ContinuationInterceptor localContinuationInterceptor = (kotlin.coroutines.experimental.ContinuationInterceptor)paramCoroutineContext.find((kotlin.coroutines.experimental.CoroutineContext.Key)kotlin.coroutines.experimental.ContinuationInterceptor.this$0);
    Object localObject = (ExperimentalContextMigration)paramCoroutineContext.find((kotlin.coroutines.experimental.CoroutineContext.Key)ExperimentalContextMigration.PREPARED);
    kotlin.coroutines.experimental.CoroutineContext localCoroutineContext = paramCoroutineContext.minusKey((kotlin.coroutines.experimental.CoroutineContext.Key)kotlin.coroutines.experimental.ContinuationInterceptor.this$0).minusKey((kotlin.coroutines.experimental.CoroutineContext.Key)ExperimentalContextMigration.PREPARED);
    if (localObject != null)
    {
      localObject = ((ExperimentalContextMigration)localObject).getContext();
      paramCoroutineContext = (kotlin.coroutines.experimental.CoroutineContext)localObject;
      if (localObject != null) {}
    }
    else
    {
  ...
  public static final kotlin.coroutines.experimental.Continuation toExperimentalContinuation(kotlin.coroutines.Continuation paramContinuation)
  {
  ...
  public static final kotlin.coroutines.experimental.CoroutineContext toExperimentalCoroutineContext(kotlin.coroutines.CoroutineContext paramCoroutineContext)
  {
    ...
    kotlin.coroutines.ContinuationInterceptor localContinuationInterceptor = (kotlin.coroutines.ContinuationInterceptor)paramCoroutineContext.remove((kotlin.coroutines.CoroutineContext.Key)kotlin.coroutines.ContinuationInterceptor.this$0);
    Object localObject = (ContextMigration)paramCoroutineContext.remove((kotlin.coroutines.CoroutineContext.Key)ContextMigration.PREPARED);
    kotlin.coroutines.CoroutineContext localCoroutineContext = paramCoroutineContext.minusKey((kotlin.coroutines.CoroutineContext.Key)kotlin.coroutines.ContinuationInterceptor.this$0).minusKey((kotlin.coroutines.CoroutineContext.Key)ContextMigration.PREPARED);
    if (localObject != null)
    {
      localObject = ((ContextMigration)localObject).getContext();
      paramCoroutineContext = (kotlin.coroutines.CoroutineContext)localObject;
      if (localObject != null) {}
    }
    else
    {
  ...
  public static final Function1 toExperimentalSuspendFunction(Function1 paramFunction1)
  {
  ...
  public static final Function2 toExperimentalSuspendFunction(Function2 paramFunction2)
  {
  ...
  public static final Function3 toExperimentalSuspendFunction(Function3 paramFunction3)
  {
