  ...
  implements Function2<T1, kotlin.coroutines.experimental.Continuation<? super R>, Object>
{
  ...
  public ExperimentalSuspendFunction1Migration(Function2 paramFunction2)
  {
  ...
  public Object invoke(Object paramObject, kotlin.coroutines.experimental.Continuation paramContinuation)
  {
    Intrinsics.checkParameterIsNotNull(paramContinuation, "continuation");
    return function.invoke(paramObject, CoroutinesMigrationKt.toContinuation(paramContinuation));
  }
}
