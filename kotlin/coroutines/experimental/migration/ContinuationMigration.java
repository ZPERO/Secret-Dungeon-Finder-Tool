  ...
  implements kotlin.coroutines.Continuation<T>
{
  ...
  public ContinuationMigration(kotlin.coroutines.experimental.Continuation paramContinuation)
  {
    continuation = paramContinuation;
    context = CoroutinesMigrationKt.toCoroutineContext(continuation.getContext());
  }
  ...
  public void resumeWith(Object paramObject)
  {
    if (Result.isSuccess-impl(paramObject)) {
      continuation.resume(paramObject);
    }
    paramObject = Result.exceptionOrNull-impl(paramObject);
    if (paramObject != null) {
      continuation.resumeWithException(paramObject);
    }
  }
}
