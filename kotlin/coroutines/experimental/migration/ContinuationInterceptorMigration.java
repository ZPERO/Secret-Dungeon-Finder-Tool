  ...
  implements kotlin.coroutines.ContinuationInterceptor
{
  ...
  {
    return (CoroutineContext.Key)kotlin.coroutines.ContinuationInterceptor.this$0;
  }
  ...
  public Continuation interceptContinuation(Continuation paramContinuation)
  {
    ...
    return CoroutinesMigrationKt.toContinuation(interceptor.interceptContinuation(CoroutinesMigrationKt.toExperimentalContinuation(paramContinuation)));
  }
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramKey, "key");
    return ContinuationInterceptor.DefaultImpls.getValue(this, paramKey);
  }
}
