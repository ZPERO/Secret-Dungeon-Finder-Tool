  ...
  implements Function3<T1, T2, kotlin.coroutines.experimental.Continuation<? super R>, Object>
{
  ...
  public ExperimentalSuspendFunction2Migration(Function3 paramFunction3)
  {
    function = paramFunction3;
  }
  ...
  public Object invoke(Object paramObject1, Object paramObject2, kotlin.coroutines.experimental.Continuation paramContinuation)
  {
    Intrinsics.checkParameterIsNotNull(paramContinuation, "continuation");
    return function.invoke(paramObject1, paramObject2, CoroutinesMigrationKt.toContinuation(paramContinuation));
  }
}
