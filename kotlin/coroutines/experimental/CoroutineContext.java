...
{
  public abstract Element find(Key paramKey);
  ...
  {
    public abstract Element find(CoroutineContext.Key paramKey);
    ...
    public static final class DefaultImpls
    {
      ...
      public static CoroutineContext minusKey(CoroutineContext.Element paramElement, CoroutineContext.Key paramKey)
      {
        ...
        if (((CoroutineContext.Element)paramElement).getKey() == paramKey) {
