...
class SequenceBuilderKt__SequenceBuilderKt
{
  ...
  public static final Iterator buildIterator(Function2 paramFunction2)
  {
    ...
    localSequenceBuilderIterator.setNextStep(IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnchecked(paramFunction2, localSequenceBuilderIterator, (Continuation)localSequenceBuilderIterator));
    return (Iterator)localSequenceBuilderIterator;
  }
  
  public static final Sequence buildSequence(Function2 paramFunction2)
  {
    Intrinsics.checkParameterIsNotNull(paramFunction2, "builderAction");
    (Sequence)new Sequence()
    {
      ...
      {
        return SequenceBuilderKt__SequenceBuilderKt.buildIterator(SequenceBuilderKt__SequenceBuilderKt.this);
      }
    };
  }
}
