  ...
  implements Continuation<T>
{
  ...
  public final Object getResult()
  {
    ...
    {
      if (RESULT.compareAndSet(this, localObject3, IntrinsicsKt__IntrinsicsJvmKt.getCOROUTINE_SUSPENDED())) {
  ...
  public void resume(Object paramObject)
  {
    do
    {
      ...
      } while (!RESULT.compareAndSet(this, localObject2, paramObject));
      return;
      if (localObject1 != IntrinsicsKt__IntrinsicsJvmKt.getCOROUTINE_SUSPENDED()) {
        break;
      }
    } while (!RESULT.compareAndSet(this, IntrinsicsKt__IntrinsicsJvmKt.getCOROUTINE_SUSPENDED(), RESUMED));
    delegate.resume(paramObject);
    return;
