...
class MapsKt__MapWithDefaultKt
{
  ...
  public static final Object getOrImplicitDefaultNullable(Map paramMap, Object paramObject)
  {
  ...
  public static final Map withDefault(Map paramMap, Function1 paramFunction1)
  {
    ...
    if ((paramMap instanceof MapWithDefault)) {
      return withDefault(((MapWithDefault)paramMap).getMap(), paramFunction1);
    }
    return (Map)new MapWithDefaultImpl(paramMap, paramFunction1);
  }
  
  public static final Map withDefaultMutable(Map paramMap, Function1 paramFunction1)
  {
    Intrinsics.checkParameterIsNotNull(paramMap, "$this$withDefault");
    Intrinsics.checkParameterIsNotNull(paramFunction1, "defaultValue");
    if ((paramMap instanceof MutableMapWithDefault)) {
      return withDefaultMutable(((MutableMapWithDefault)paramMap).getMap(), paramFunction1);
    }
