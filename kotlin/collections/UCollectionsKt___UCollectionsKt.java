...
class UCollectionsKt___UCollectionsKt
{
  ...
  public static final int sumOfUByte(Iterable paramIterable)
  {
  ...
  public static final int sumOfUInt(Iterable paramIterable)
  {
    Intrinsics.checkParameterIsNotNull(paramIterable, "$this$sum");
    paramIterable = paramIterable.iterator();
  ...
  public static final long sumOfULong(Iterable paramIterable)
  {
    Intrinsics.checkParameterIsNotNull(paramIterable, "$this$sum");
    paramIterable = paramIterable.iterator();
  ...
  public static final int sumOfUShort(Iterable paramIterable)
  {
    Intrinsics.checkParameterIsNotNull(paramIterable, "$this$sum");
    paramIterable = paramIterable.iterator();
  ...
  public static final byte[] toUByteArray(Collection paramCollection)
  {
  ...
  public static final int[] toUIntArray(Collection paramCollection)
  {
  ...
  public static final long[] toULongArray(Collection paramCollection)
  {
  ...
  public static final short[] toUShortArray(Collection paramCollection)
  {
