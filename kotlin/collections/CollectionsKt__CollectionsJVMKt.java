...
class CollectionsKt__CollectionsJVMKt
{
  ...
  private static final Object[] copyToArrayImpl(Collection paramCollection, Object[] paramArrayOfObject)
  {
    if (paramArrayOfObject != null)
    {
      paramCollection = CollectionToArray.toArray(paramCollection, paramArrayOfObject);
  ...
  public static final Object[] copyToArrayOfAny(Object[] paramArrayOfObject, boolean paramBoolean)
  {
    Intrinsics.checkParameterIsNotNull(paramArrayOfObject, "$this$copyToArrayOfAny");
    if ((paramBoolean) && (Intrinsics.areEqual(paramArrayOfObject.getClass(), [Ljava.lang.Object.class))) {
      return paramArrayOfObject;
    }
    paramArrayOfObject = Arrays.copyOf(paramArrayOfObject, paramArrayOfObject.length, [Ljava.lang.Object.class);
    Intrinsics.checkExpressionValueIsNotNull(paramArrayOfObject, "java.util.Arrays.copyOf(? Array<Any?>::class.java)");
    return paramArrayOfObject;
  }
  ...
  public static final List listOf(Object paramObject)
  {
    ...
    Intrinsics.checkExpressionValueIsNotNull(paramObject, "java.util.Collections.singletonList(element)");
    return paramObject;
  }
  
  private static final List toList(Enumeration paramEnumeration)
  {
