  ...
  extends GroupingKt__GroupingJVMKt
{
  ...
  public static final Map aggregate(Grouping paramGrouping, Function4 paramFunction4)
  {
  ...
  public static final Map aggregateTo(Grouping paramGrouping, Map paramMap, Function4 paramFunction4)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      boolean bool;
      if ((localObject3 == null) && (!paramMap.containsKey(localObject2))) {
        bool = true;
      } else {
        bool = false;
      }
      paramMap.put(localObject2, paramFunction4.invoke(localObject2, localObject3, localObject1, Boolean.valueOf(bool)));
    }
    return paramMap;
  }
  
  public static final Map eachCountTo(Grouping paramGrouping, Map paramMap)
  {
    ...
    while (localIterator.hasNext())
    {
      Object localObject3 = paramGrouping.keyOf(localIterator.next());
      Object localObject2 = paramMap.get(localObject3);
      Object localObject1 = localObject2;
      int i;
      if ((localObject2 == null) && (!paramMap.containsKey(localObject3))) {
        i = 1;
      } else {
        i = 0;
      }
      ...
      paramMap.put(localObject3, Integer.valueOf(((Number)localObject1).intValue() + 1));
    }
    return paramMap;
  }
  
  public static final Map fold(Grouping paramGrouping, Object paramObject, Function2 paramFunction2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      Object localObject4 = paramGrouping.keyOf(localObject3);
      Object localObject2 = localMap.get(localObject4);
      Object localObject1 = localObject2;
      int i;
      if ((localObject2 == null) && (!localMap.containsKey(localObject4))) {
        i = 1;
      } else {
        i = 0;
      }
      ...
      localMap.put(localObject4, paramFunction2.invoke(localObject1, localObject3));
    }
    return localMap;
  }
  
  public static final Map fold(Grouping paramGrouping, Function2 paramFunction2, Function3 paramFunction3)
  {
    Intrinsics.checkParameterIsNotNull(paramGrouping, "$this$fold");
    ...
    while (localIterator.hasNext())
    {
      ...
      if (i != 0) {
        localObject1 = paramFunction2.invoke(localObject4, localObject3);
      }
      localMap.put(localObject4, paramFunction3.invoke(localObject4, localObject1, localObject3));
    }
    return localMap;
  }
  
  public static final Map foldTo(Grouping paramGrouping, Map paramMap, Object paramObject, Function2 paramFunction2)
  {
    ...
    while (localIterator.hasNext())
    {
      Object localObject3 = localIterator.next();
      Object localObject4 = paramGrouping.keyOf(localObject3);
      Object localObject2 = paramMap.get(localObject4);
      Object localObject1 = localObject2;
      int i;
      if ((localObject2 == null) && (!paramMap.containsKey(localObject4))) {
        i = 1;
      } else {
        i = 0;
      }
      ...
      paramMap.put(localObject4, paramFunction2.invoke(localObject1, localObject3));
    }
    return paramMap;
  }
  
  public static final Map foldTo(Grouping paramGrouping, Map paramMap, Function2 paramFunction2, Function3 paramFunction3)
  {
    Intrinsics.checkParameterIsNotNull(paramGrouping, "$this$foldTo");
    Intrinsics.checkParameterIsNotNull(paramMap, "destination");
    Intrinsics.checkParameterIsNotNull(paramFunction2, "initialValueSelector");
    ...
    while (localIterator.hasNext())
    {
      ...
      paramMap.put(localObject4, paramFunction3.invoke(localObject4, localObject1, localObject3));
    }
    return paramMap;
  }
  
  public static final Map reduce(Grouping paramGrouping, Function3 paramFunction3)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      int i;
      if ((localObject4 == null) && (!localMap.containsKey(localObject3))) {
        i = 1;
      } else {
        i = 0;
      }
      if (i == 0) {
        localObject1 = paramFunction3.invoke(localObject3, localObject4, localObject2);
      }
  ...
  public static final Map reduceTo(Grouping paramGrouping, Map paramMap, Function3 paramFunction3)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      Object localObject1 = localObject2;
      Object localObject3 = paramGrouping.keyOf(localObject2);
      Object localObject4 = paramMap.get(localObject3);
      int i;
      if ((localObject4 == null) && (!paramMap.containsKey(localObject3))) {
        i = 1;
      } else {
        i = 0;
      }
