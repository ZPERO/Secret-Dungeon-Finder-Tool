  ...
  extends AbstractMutableList<T>
{
  ...
  {
    delegate.add(CollectionsKt__ReversedViewsKt.access$reversePositionIndex(this, paramInt), paramObject);
  }
  ...
  {
    return delegate.set(CollectionsKt__ReversedViewsKt.access$reverseElementIndex(this, paramInt), paramObject);
  }
}
