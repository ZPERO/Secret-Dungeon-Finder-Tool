  ...
  extends MathKt__MathHKt
{
  ...
  private static final float Round(float paramFloat, int paramInt)
  {
  ...
  public static final double acosh(double paramDouble)
  {
    ...
    if (paramDouble > Constants.upper_taylor_2_bound) {
      return Math.log(paramDouble) + Constants.LN_2;
    }
    Double.isNaN(1.0D);
    double d = paramDouble - 1.0D;
  ...
  public static final double asinh(double paramDouble)
  {
    if (paramDouble >= Constants.taylor_n_bound)
    {
      if (paramDouble > Constants.upper_taylor_n_bound)
      {
        ...
        paramDouble *= 2.0D;
        Double.isNaN(1.0D);
        return Math.log(paramDouble + 1.0D / paramDouble);
      }
      Double.isNaN(1.0D);
      return Math.log(paramDouble + Math.sqrt(paramDouble * paramDouble + 1.0D));
    }
    ...
    {
      Double.isNaN(6.0D);
      d = paramDouble - paramDouble * paramDouble * paramDouble / 6.0D;
    }
    return d;
  }
  ...
  public static final double atanh(double paramDouble)
  {
    ...
    if (Math.abs(paramDouble) < Constants.taylor_n_bound)
    {
      ...
      {
        Double.isNaN(3.0D);
        return paramDouble + paramDouble * paramDouble * paramDouble / 3.0D;
      }
    }
    else
    {
      Double.isNaN(1.0D);
      Double.isNaN(1.0D);
      paramDouble = Math.log((1.0D + paramDouble) / (1.0D - paramDouble));
      Double.isNaN(2.0D);
      d = paramDouble / 2.0D;
    }
    return d;
  ...
  public static final float calcMinMax(float paramFloat1, float paramFloat2)
  {
  ...
  private static final double calculateWeight(double paramDouble1, double paramDouble2)
  {
  ...
  private static final double cosd(double paramDouble)
  {
  ...
  private static final double evaluate(double paramDouble)
  {
    return Math.abs(paramDouble);
  }
  
  private static final float evaluate(float paramFloat)
  {
  ...
  private static final double factorial(double paramDouble)
  {
  ...
  private static final int gapToSide(int paramInt1, int paramInt2)
  {
  ...
  private static final int getColorIndex(int paramInt)
  {
    return Math.abs(paramInt);
  }
  
  private static final float getFrameAdjustedFriction(float paramFloat)
  {
  ...
  private static final double gudermannInverse(double paramDouble)
  {
  ...
  {
    return (float)(Math.log(paramFloat) / Constants.LN_2);
  }
  
  private static final double longitudeDistance(double paramDouble1, double paramDouble2)
  {
  ...
  private static final int removeItems(int paramInt1, int paramInt2)
  {
  ...
  private static final double sind(double paramDouble)
  {
  ...
  private static final double tand(double paramDouble)
  {
  ...
  private static final float viscousFluid(float paramFloat)
  {
