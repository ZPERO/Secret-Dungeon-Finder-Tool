...
public final class Delegates
{
  ...
  public final ReadWriteProperty observable(final Object paramObject, Function3 paramFunction3)
  {
    Intrinsics.checkParameterIsNotNull(paramFunction3, "onChange");
    (ReadWriteProperty)new ObservableProperty(paramFunction3)
    {
      protected void afterChange(KProperty paramAnonymousKProperty, Object paramAnonymousObject1, Object paramAnonymousObject2)
      {
        Intrinsics.checkParameterIsNotNull(paramAnonymousKProperty, "property");
        invoke(paramAnonymousKProperty, paramAnonymousObject1, paramAnonymousObject2);
      }
    };
  }
  
  public final ReadWriteProperty vetoable(final Object paramObject, Function3 paramFunction3)
  {
    Intrinsics.checkParameterIsNotNull(paramFunction3, "onChange");
    (ReadWriteProperty)new ObservableProperty(paramFunction3)
    {
      protected boolean beforeChange(KProperty paramAnonymousKProperty, Object paramAnonymousObject1, Object paramAnonymousObject2)
      {
        Intrinsics.checkParameterIsNotNull(paramAnonymousKProperty, "property");
        return ((Boolean)invoke(paramAnonymousKProperty, paramAnonymousObject1, paramAnonymousObject2)).booleanValue();
      }
    };
  }
}
