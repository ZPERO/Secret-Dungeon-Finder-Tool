  ...
  extends NumbersKt__BigDecimalsKt
{
  ...
  private static final BigInteger calculateKey(BigInteger paramBigInteger1, BigInteger paramBigInteger2)
  {
  ...
  private static final BigInteger mod(BigInteger paramBigInteger1, BigInteger paramBigInteger2)
  {
  ...
  private static final BigInteger next(BigInteger paramBigInteger)
  {
  ...
  private static final BigInteger next(BigInteger paramBigInteger1, BigInteger paramBigInteger2)
  {
  ...
  private static final BigInteger previous(BigInteger paramBigInteger)
  {
  ...
  private static final BigInteger sqrt(BigInteger paramBigInteger, int paramInt)
  {
  ...
  private static final BigInteger sqrtFloor(BigInteger paramBigInteger, int paramInt)
  {
  ...
  private static final BigInteger toString(BigInteger paramBigInteger)
  {
  ...
  private static final BigInteger validate(BigInteger paramBigInteger1, BigInteger paramBigInteger2)
  {
