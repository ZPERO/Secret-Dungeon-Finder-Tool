...
{
  private static final short addElem(short paramShort1, short paramShort2)
  {
    return (short)(paramShort1 ^ paramShort2);
  }
  
  private static final byte copySign(byte paramByte1, byte paramByte2)
  {
    return (byte)(paramByte1 ^ paramByte2);
  }
  
  private static final short copySign(short paramShort1, short paramShort2)
  {
    return (short)(paramShort1 | paramShort2);
  }
  
  private static final byte createTag(byte paramByte1, byte paramByte2)
  {
    return (byte)(paramByte1 | paramByte2);
  }
  
  private static final byte encryptByte(byte paramByte)
  {
    return (byte)paramByte;
  }
  
  private static final short isInSubnet(short paramShort)
  {
    return (short)paramShort;
  }
  
  private static final short prop(short paramShort1, short paramShort2)
  {
    return (short)(paramShort1 & paramShort2);
  }
  
  private static final byte writeByte(byte paramByte1, byte paramByte2)
  {
    return (byte)(paramByte1 & paramByte2);
  }
}
