...
public final class ConsoleKt
{
  ...
  private static final Lazy decoder$delegate = LazyKt__LazyJVMKt.lazy((Function0)decoder.2.INSTANCE);
  ...
  public static final String readLine(InputStream paramInputStream, CharsetDecoder paramCharsetDecoder)
  {
    ...
    float f = paramCharsetDecoder.maxCharsPerByte();
    int k = 0;
    int i;
    if (f <= 1.0F) {
      i = 1;
