  ...
  implements Sequence<File>
{
  ...
  private FileTreeWalk(File paramFile, FileWalkDirection paramFileWalkDirection, Function1 paramFunction11, Function1 paramFunction12, Function2 paramFunction2, int paramInt)
  {
    start = paramFile;
    direction = paramFileWalkDirection;
    onEnter = paramFunction11;
    onLeave = paramFunction12;
  ...
  public final FileTreeWalk onEnter(Function1 paramFunction1)
  {
  ...
  public final FileTreeWalk onFail(Function2 paramFunction2)
  {
  ...
  public final FileTreeWalk onLeave(Function1 paramFunction1)
  {
    Intrinsics.checkParameterIsNotNull(paramFunction1, "function");
    ...
    extends AbstractIterator<File>
  {
    ...
    public FileTreeWalkIterator()
    {
      ...
      {
        state.push(directoryState(FileTreeWalk.access$getStart$p(FileTreeWalk.this)));
        return;
      }
      if (FileTreeWalk.access$getStart$p(FileTreeWalk.this).isFile())
      {
        state.push(new SingleFileState(FileTreeWalk.access$getStart$p(FileTreeWalk.this)));
        return;
      }
      done();
    }
    ...
    {
      FileWalkDirection localFileWalkDirection = FileTreeWalk.access$getDirection$p(FileTreeWalk.this);
    ...
    private final File gotoNext()
    {
      ...
      for (;;)
      {
        FileTreeWalk.WalkState localWalkState = (FileTreeWalk.WalkState)state.peek();
        ...
        {
          if (Intrinsics.areEqual(localFile, localWalkState.getRoot())) {
            break;
          }
          if (!localFile.isDirectory()) {
            return localFile;
          }
          if (state.size() >= FileTreeWalk.access$getMaxDepth$p(FileTreeWalk.this)) {
            return localFile;
          }
      ...
      extends FileTreeWalk.DirectoryState
    {
      ...
      public BottomUpDirectoryState(File paramFile)
      {
        super();
      }
      ...
      public File step()
      {
        ...
        {
          localObject = FileTreeWalk.access$getOnEnter$p(FileTreeWalk.this);
          ...
          if (fileList == null)
          {
            localObject = FileTreeWalk.access$getOnFail$p(FileTreeWalk.this);
            if (localObject != null) {
        ...
        localObject = FileTreeWalk.access$getOnLeave$p(FileTreeWalk.this);
        if (localObject != null) {
      ...
      extends FileTreeWalk.WalkState
    {
      ...
      public SingleFileState(File paramFile)
      {
        super();
        if (_Assertions.ENABLED)
        {
      ...
      extends FileTreeWalk.DirectoryState
    {
      ...
      public TopDownDirectoryState(File paramFile)
      {
        super();
      }
