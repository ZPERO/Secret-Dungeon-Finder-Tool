...
public final class FilePathComponents
{
  ...
  public FilePathComponents(File paramFile, List paramList)
  {
    root = paramFile;
    segments = paramList;
  }
  ...
  public final FilePathComponents copy(File paramFile, List paramList)
  {
  ...
  public final File subPath(int paramInt1, int paramInt2)
  {
    if ((paramInt1 >= 0) && (paramInt1 <= paramInt2) && (paramInt2 <= getSize()))
    {
      ...
      return new File(CollectionsKt___CollectionsKt.joinToString$default(localIterable, (CharSequence)str, null, null, 0, null, null, 62, null));
    }
