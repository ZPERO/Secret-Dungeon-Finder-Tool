...
public final class UnsignedKt
{
  public static final int doubleToUInt(double paramDouble)
  {
    ...
    Double.isNaN(2.147483647E9D);
    return UInt.constructor-impl(UInt.constructor-impl((int)(paramDouble - 2.147483647E9D)) + UInt.constructor-impl(Integer.MAX_VALUE));
  }
  ...
  public static final double ulongToDouble(long paramLong)
  {
    ...
    Double.isNaN(d1);
    Double.isNaN(2048.0D);
    double d2 = paramLong & 0x7FF;
    Double.isNaN(d2);
    return d1 * 2048.0D + d2;
  }
  ...
  public static final String ulongToString(long paramLong, int paramInt)
  {
    if (paramLong >= 0L)
    {
      localObject = Long.toString(paramLong, CharsKt__CharJVMKt.checkRadix(paramInt));
    ...
    String str = Long.toString(l1, CharsKt__CharJVMKt.checkRadix(paramInt));
    Intrinsics.checkExpressionValueIsNotNull(str, "java.lang.Long.toString(this, checkRadix(radix))");
    ((StringBuilder)localObject).append(str);
    str = Long.toString(paramLong, CharsKt__CharJVMKt.checkRadix(paramInt));
    Intrinsics.checkExpressionValueIsNotNull(str, "java.lang.Long.toString(this, checkRadix(radix))");
    ((StringBuilder)localObject).append(str);
