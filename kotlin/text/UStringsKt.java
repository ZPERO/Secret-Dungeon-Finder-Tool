...
public final class UStringsKt
{
  ...
  {
    return UnsignedKt.ulongToString(paramLong, CharsKt__CharJVMKt.checkRadix(paramInt));
  }
  
  public static final String toString-LxnNnR4(byte paramByte, int paramInt)
  {
    String str = Integer.toString(paramByte & 0xFF, CharsKt__CharJVMKt.checkRadix(paramInt));
  ...
  {
    String str = Long.toString(paramInt1 & 0xFFFFFFFF, CharsKt__CharJVMKt.checkRadix(paramInt2));
  ...
  {
    String str = Integer.toString(paramShort & 0xFFFF, CharsKt__CharJVMKt.checkRadix(paramInt));
    Intrinsics.checkExpressionValueIsNotNull(str, "java.lang.Integer.toStri?(this, checkRadix(radix))");
    return str;
  }
  ...
  public static final byte toUByte(String paramString)
  {
    ...
    StringsKt__StringNumberConversionsKt.numberFormatError(paramString);
  ...
  public static final UInt toUIntOrNull(String paramString, int paramInt)
  {
    ...
    {
      int i2 = CharsKt__CharJVMKt.digitOf(paramString.charAt(i), paramInt);
      if (i2 < 0) {
        return null;
      }
      j = m;
  ...
  public static final ULong toULongOrNull(String paramString, int paramInt)
  {
    ...
    {
      k = CharsKt__CharJVMKt.digitOf(paramString.charAt(i), paramInt);
      if (k < 0) {
        return null;
      }
      l1 = l3;
