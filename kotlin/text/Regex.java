  ...
  implements Serializable
{
  ...
  public Regex(String paramString, Set paramSet)
  {
    this(paramString);
  }
  ...
  public final Sequence findAll(final CharSequence paramCharSequence, final int paramInt)
  {
    Intrinsics.checkParameterIsNotNull(paramCharSequence, "input");
    SequencesKt__SequencesKt.generateSequence((Function0)new Lambda(paramCharSequence)
    {
      public final MatchResult invoke()
      {
        return find(paramCharSequence, paramInt);
      }
  ...
  public final Set getOptions()
  {
    ...
    CollectionsKt__MutableCollectionsKt.retainAll((Iterable)localObject, (Function1)new Regex.fromInt..inlined.apply.lambda.1(i));
  ...
  public final String replace(CharSequence paramCharSequence, Function1 paramFunction1)
  {
    Intrinsics.checkParameterIsNotNull(paramCharSequence, "input");
    Intrinsics.checkParameterIsNotNull(paramFunction1, "transform");
    int i = 0;
    MatchResult localMatchResult2 = find$default(this, paramCharSequence, 0, 2, null);
    MatchResult localMatchResult1 = localMatchResult2;
    if (localMatchResult2 != null)
    {
      ...
      do
      {
        if (localMatchResult1 == null) {
          Intrinsics.throwNpe();
        }
        localStringBuilder.append(paramCharSequence, i, localMatchResult1.getRange().getStart().intValue());
        localStringBuilder.append((CharSequence)paramFunction1.invoke(localMatchResult1));
        j = localMatchResult1.getRange().getEndInclusive().intValue() + 1;
        localMatchResult2 = localMatchResult1.next();
        localMatchResult1 = localMatchResult2;
        if (j >= k) {
          break;
        }
        i = j;
      } while (localMatchResult2 != null);
      if (j < k) {
  ...
  public final List split(CharSequence paramCharSequence, int paramInt)
  {
    Intrinsics.checkParameterIsNotNull(paramCharSequence, "input");
    int j = 0;
    int i;
    ...
    if (i != 0)
    {
      ...
      if ((localMatcher.find()) && (paramInt != 1))
      {
        i = 10;
        if (paramInt > 0) {
          i = RangesKt___RangesKt.coerceAtMost(paramInt, 10);
        }
        ...
        do
        {
          ...
          i = localMatcher.end();
          paramInt = i;
        } while (((k < 0) || (localArrayList.size() != k)) && (localMatcher.find()));
