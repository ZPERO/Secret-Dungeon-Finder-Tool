  ...
  extends StringsKt__StringNumberConversionsKt
{
  ...
  public static final boolean endsWith(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    return regionMatches(paramString1, paramString1.length() - paramString2.length(), paramString2, 0, paramString2.length(), true);
  }
  ...
  public static final Comparator getCASE_INSENSITIVE_ORDER(StringCompanionObject paramStringCompanionObject)
  {
  ...
  public static final boolean isBlank(CharSequence paramCharSequence)
  {
    ...
    {
      Object localObject = (Iterable)StringsKt__StringsKt.getIndices(paramCharSequence);
      ...
      } while (CharsKt__CharJVMKt.isWhitespace(paramCharSequence.charAt(((IntIterator)localObject).nextInt())));
      i = 0;
    }
    return i != 0;
  }
  ...
  public static final boolean regionMatches(CharSequence paramCharSequence1, int paramInt1, CharSequence paramCharSequence2, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (((paramCharSequence1 instanceof String)) && ((paramCharSequence2 instanceof String))) {
      return regionMatches((String)paramCharSequence1, paramInt1, (String)paramCharSequence2, paramInt2, paramInt3, paramBoolean);
    }
    return StringsKt__StringsKt.regionMatchesImpl(paramCharSequence1, paramInt1, paramCharSequence2, paramInt2, paramInt3, paramBoolean);
  }
      ...
      if (paramInt != 0) {
        if (paramInt != 1)
        {
          ...
          if (j != 0)
          {
            if (j != 1)
            {
              StringBuilder localStringBuilder = new StringBuilder(paramCharSequence.length() * paramInt);
              if (1 <= paramInt)
              {
                j = m;
                for (;;)
  ...
  public static final String replace(String paramString, char paramChar1, char paramChar2, boolean paramBoolean)
  {
    ...
    return SequencesKt___SequencesKt.joinToString$default(StringsKt__StringsKt.splitToSequence$default((CharSequence)paramString, new char[] { paramChar1 }, paramBoolean, 0, 4, null), (CharSequence)String.valueOf(paramChar2), null, null, 0, null, null, 62, null);
  }
  ...
  public static final String replace(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    return SequencesKt___SequencesKt.joinToString$default(StringsKt__StringsKt.splitToSequence$default((CharSequence)paramString1, new String[] { paramString2 }, paramBoolean, 0, 4, null), (CharSequence)paramString3, null, null, 0, null, null, 62, null);
  }
  ...
  public static final String replaceFirst(String paramString, char paramChar1, char paramChar2, boolean paramBoolean)
  {
    ...
    int i = StringsKt__StringsKt.indexOf$default(localCharSequence, paramChar1, 0, paramBoolean, 2, null);
    if (i < 0) {
      return paramString;
    }
    return StringsKt__StringsKt.replaceRange(localCharSequence, i, i + 1, (CharSequence)String.valueOf(paramChar2)).toString();
  }
  ...
  public static final String replaceFirst(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    int i = StringsKt__StringsKt.indexOf$default(localCharSequence, paramString2, 0, paramBoolean, 2, null);
    if (i < 0) {
      return paramString1;
    }
    return StringsKt__StringsKt.replaceRange(localCharSequence, i, paramString2.length() + i, (CharSequence)paramString3).toString();
  }
  
  public static final List split(CharSequence paramCharSequence, Pattern paramPattern, int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      return ArraysKt___ArraysJvmKt.asList(paramCharSequence);
    }
    paramCharSequence = new StringBuilder();
  ...
  public static final boolean startsWith(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    return regionMatches(paramString1, paramInt, paramString2, 0, paramString2.length(), paramBoolean);
  }
  ...
  public static final boolean startsWith(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    return regionMatches(paramString1, 0, paramString2, 0, paramString2.length(), paramBoolean);
  }
