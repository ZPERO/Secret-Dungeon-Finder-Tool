...
public final class RegexKt
{
  ...
  {
    return RangesKt___RangesKt.until(paramMatchResult.start(), paramMatchResult.end());
  }
  
  private static final IntRange range(java.util.regex.MatchResult paramMatchResult, int paramInt)
  {
    return RangesKt___RangesKt.until(paramMatchResult.start(paramInt), paramMatchResult.end(paramInt));
  }
  
  private static final int toInt(Iterable paramIterable)
  {
