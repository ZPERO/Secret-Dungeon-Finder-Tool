...
class StringsKt__IndentKt
{
  ...
  private static final Function1 getIndentFunction$StringsKt__IndentKt(String paramString)
  {
    int i;
    ...
    (Function1)new Lambda(paramString)
    {
      public final String invoke(String paramAnonymousString)
      {
        ...
        localStringBuilder.append(StringsKt__IndentKt.this);
  ...
  private static final int indentWidth$StringsKt__IndentKt(String paramString)
  {
    ...
    while (i < j)
    {
      if ((CharsKt__CharJVMKt.isWhitespace(localCharSequence.charAt(i)) ^ true)) {
        break label46;
      }
      i += 1;
    }
  ...
  public static final String prependIndent(String paramString1, String paramString2)
  {
    ...
    SequencesKt___SequencesKt.joinToString$default(SequencesKt___SequencesKt.map(StringsKt__StringsKt.lineSequence((CharSequence)paramString1), (Function1)new Lambda(paramString2)
    {
      public final String invoke(String paramAnonymousString)
      {
        Intrinsics.checkParameterIsNotNull(paramAnonymousString, "it");
        Object localObject;
        if (StringsKt__StringsJVMKt.isBlank((CharSequence)paramAnonymousString))
        {
          localObject = paramAnonymousString;
          if (paramAnonymousString.length() < length()) {
            return StringsKt__IndentKt.this;
          }
        }
        else
        {
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append(StringsKt__IndentKt.this);
  ...
  private static final String reindent$StringsKt__IndentKt(List paramList, int paramInt, Function1 paramFunction11, Function1 paramFunction12)
  {
    int j = CollectionsKt__CollectionsKt.getLastIndex(paramList);
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((i == 0) || (i == j)) && (StringsKt__StringsJVMKt.isBlank((CharSequence)str1)))
      {
        paramList = null;
      }
      else
    ...
    paramList = ((StringBuilder)CollectionsKt___CollectionsKt.joinTo$default((Iterable)localCollection, (Appendable)new StringBuilder(paramInt), (CharSequence)"\n", null, null, 0, null, null, 124, null)).toString();
  ...
  public static final String replaceIndent(String paramString1, String paramString2)
  {
    ...
    Object localObject2 = StringsKt__StringsKt.lines((CharSequence)paramString1);
    ...
    while (((Iterator)localObject4).hasNext())
    {
      ...
      if ((StringsKt__StringsJVMKt.isBlank((CharSequence)localObject5) ^ true)) {
        ((Collection)localObject3).add(localObject5);
      }
    }
    localObject4 = (Iterable)localObject3;
    localObject3 = (Collection)new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault((Iterable)localObject4, 10));
    localObject4 = ((Iterable)localObject4).iterator();
    while (((Iterator)localObject4).hasNext()) {
      ((Collection)localObject3).add(Integer.valueOf(indentWidth$StringsKt__IndentKt((String)((Iterator)localObject4).next())));
    }
    localObject3 = (Integer)CollectionsKt___CollectionsKt.min((Iterable)localObject3);
    int j = 0;
    int i;
    ...
    int i1 = CollectionsKt__CollectionsKt.getLastIndex((List)localObject2);
    ...
    while (((Iterator)localObject4).hasNext())
    {
      ...
      if (((j == 0) || (j == i1)) && (StringsKt__StringsJVMKt.isBlank((CharSequence)paramString2)))
      {
        paramString1 = null;
      }
      else
      {
        localObject1 = StringsKt___StringsKt.drop(paramString2, i);
    ...
    paramString1 = ((StringBuilder)CollectionsKt___CollectionsKt.joinTo$default((Iterable)localObject2, (Appendable)new StringBuilder(k + m * n), (CharSequence)"\n", null, null, 0, null, null, 124, null)).toString();
  ...
  public static final String replaceIndentByMargin(String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((StringsKt__StringsJVMKt.isBlank((CharSequence)paramString3) ^ true))
    {
      Object localObject = StringsKt__StringsKt.lines((CharSequence)paramString1);
      int k = paramString1.length();
      int m = paramString2.length();
      int n = ((List)localObject).size();
      Function1 localFunction1 = getIndentFunction$StringsKt__IndentKt(paramString2);
      int i1 = CollectionsKt__CollectionsKt.getLastIndex((List)localObject);
      ...
      while (localIterator.hasNext())
      {
        ...
        paramString2 = null;
        if (((j == 0) || (j == i1)) && (StringsKt__StringsJVMKt.isBlank((CharSequence)localObject)))
        {
          paramString1 = null;
        }
        else
        {
          ...
          while (i < i2)
          {
            if ((CharsKt__CharJVMKt.isWhitespace(paramString1.charAt(i)) ^ true)) {
              break label213;
            }
            i += 1;
          }
          i = -1;
          label213:
          if ((i != -1) && (StringsKt__StringsJVMKt.startsWith$default((String)localObject, paramString3, i, false, 4, null)))
          {
      ...
      paramString1 = ((StringBuilder)CollectionsKt___CollectionsKt.joinTo$default((Iterable)localCollection, (Appendable)new StringBuilder(k + m * n), (CharSequence)"\n", null, null, 0, null, null, 124, null)).toString();
      Intrinsics.checkExpressionValueIsNotNull(paramString1, "mapIndexedNotNull { inde?\"\\n\")\n        .toString()");
      return paramString1;
    }
  ...
  public static final String trimIndent(String paramString)
  {
    ...
    return replaceIndent(paramString, "");
  }
  ...
  public static final String trimMargin(String paramString1, String paramString2)
  {
    ...
    return replaceIndentByMargin(paramString1, "", paramString2);
  }
}
