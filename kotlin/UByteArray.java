  ...
  implements Collection<UByte>, KMappedMarker
{
  ...
  {
    return ArraysKt___ArraysKt.contains(paramArrayOfByte, paramByte);
  }
  
  public static boolean containsAll-impl(byte[] paramArrayOfByte, Collection paramCollection)
  {
    ...
    while (paramCollection.hasNext())
    {
      ...
      int i;
      if (((localObject instanceof UByte)) && (ArraysKt___ArraysKt.contains(paramArrayOfByte, ((UByte)localObject).unbox-impl()))) {
        i = 1;
      } else {
        i = 0;
      }
  ...
  {
    return contains-7apg3OU(storage, paramByte);
  }
