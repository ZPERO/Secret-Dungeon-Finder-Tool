  ...
  extends ClosedRange<T>
{
  ...
  public abstract boolean lessThanOrEquals(Comparable paramComparable1, Comparable paramComparable2);
  
  @Metadata(bv={1, 0, 3}, k=3, mv={1, 1, 15})
  public static final class DefaultImpls
  {
    public static boolean contains(ClosedFloatingPointRange paramClosedFloatingPointRange, Comparable paramComparable)
    {
      Intrinsics.checkParameterIsNotNull(paramComparable, "value");
      return (paramClosedFloatingPointRange.lessThanOrEquals(paramClosedFloatingPointRange.getStart(), paramComparable)) && (paramClosedFloatingPointRange.lessThanOrEquals(paramComparable, paramClosedFloatingPointRange.getEndInclusive()));
    }
    
    public static boolean isEmpty(ClosedFloatingPointRange paramClosedFloatingPointRange)
    {
