  ...
  implements Iterable<UInt>, KMappedMarker
{
  ...
  private UIntProgression(int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 != 0)
    {
      ...
      {
        first = paramInt1;
        last = UProgressionUtilKt.getProgressionLastElement-Nkh28Cs(paramInt1, paramInt2, paramInt3);
        step = paramInt3;
        return;
      }
  ...
  {
    return (UIntIterator)new UIntProgressionIterator(first, last, step, null);
  }
  ...
  public String toString()
  {
    ...
    if (step > 0)
    {
      ...
      localStringBuilder.append(UInt.toString-impl(first));
      localStringBuilder.append("..");
      localStringBuilder.append(UInt.toString-impl(last));
