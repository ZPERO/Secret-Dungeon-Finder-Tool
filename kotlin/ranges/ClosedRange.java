...
public abstract interface ClosedRange<T extends Comparable<? super T>>
{
  ...
  {
    public static boolean contains(ClosedRange paramClosedRange, Comparable paramComparable)
    {
      Intrinsics.checkParameterIsNotNull(paramComparable, "value");
      return (paramComparable.compareTo(paramClosedRange.getStart()) >= 0) && (paramComparable.compareTo(paramClosedRange.getEndInclusive()) <= 0);
    }
    
    public static boolean isEmpty(ClosedRange paramClosedRange)
    {
