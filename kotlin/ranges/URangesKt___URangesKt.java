...
class URangesKt___URangesKt
{
  ...
  public static final long coerceIn-JPwROB0(long paramLong, ClosedRange paramClosedRange)
  {
    Intrinsics.checkParameterIsNotNull(paramClosedRange, "range");
    if ((paramClosedRange instanceof ClosedFloatingPointRange)) {
      return ((ULong)RangesKt___RangesKt.coerceIn(ULong.box-impl(paramLong), (ClosedFloatingPointRange)paramClosedRange)).unbox-impl();
    }
  ...
  public static final int coerceIn-wuiCnnA(int paramInt, ClosedRange paramClosedRange)
  {
    Intrinsics.checkParameterIsNotNull(paramClosedRange, "range");
    if ((paramClosedRange instanceof ClosedFloatingPointRange)) {
      return ((UInt)RangesKt___RangesKt.coerceIn(UInt.box-impl(paramInt), (ClosedFloatingPointRange)paramClosedRange)).unbox-impl();
    }
    if (!paramClosedRange.isEmpty())
    {
  ...
  {
    return random(paramUIntRange, (Random)Random.Default);
  }
  ...
  {
    return random(paramULongRange, (Random)Random.Default);
  }
