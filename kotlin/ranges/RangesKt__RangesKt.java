  ...
  extends RangesKt__RangesJVMKt
{
  ...
  private static final boolean contains(Iterable paramIterable, Object paramObject)
  {
    Intrinsics.checkParameterIsNotNull(paramIterable, "$this$contains");
    return (paramObject != null) && (((ClosedRange)paramIterable).contains((Comparable)paramObject));
  }
  ...
  public static final ClosedRange rangeTo(Comparable paramComparable1, Comparable paramComparable2)
  {
    Intrinsics.checkParameterIsNotNull(paramComparable1, "$this$rangeTo");
    Intrinsics.checkParameterIsNotNull(paramComparable2, "that");
    return (ClosedRange)new ComparableRange(paramComparable1, paramComparable2);
  }
}
