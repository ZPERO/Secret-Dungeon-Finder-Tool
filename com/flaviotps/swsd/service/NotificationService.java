  ...
  extends FirebaseMessagingService
{
  ...
  private final boolean isFilteredDungeon(Set paramSet, SecretDungeonModel paramSecretDungeonModel)
  {
    if (paramSet != null)
    {
      if (paramSet.isEmpty()) {
      ...
      while (paramSet.hasNext()) {
        if (StringsKt__StringsJVMKt.equals(StringsKt__StringsJVMKt.replace$default((String)paramSet.next(), " ", "", false, 4, null), StringsKt__StringsJVMKt.replace$default(paramSecretDungeonModel.getMonster().getGenericName(), " ", "", false, 4, null), true)) {
          return true;
        }
      }
      return false;
  ...
  private final void sendFriendRequestNotification(FriendRequestModel paramFriendRequestModel)
  {
    ...
    ((RemoteViews)localObject).setTextViewText(2131361961, (CharSequence)StringsKt__StringsJVMKt.replace$default(str, "%s", paramFriendRequestModel.getMonster(), false, 4, null));
