  ...
  extends TypeAdapter<T>
{
  ...
  public void write(JsonWriter paramJsonWriter, Object paramObject)
    throws IOException
  {
    JsonSerializer localJsonSerializer = serializer;
    ...
    Streams.write(localJsonSerializer.serialize(paramObject, typeToken.getType(), context), paramJsonWriter);
  }
    ...
    implements TypeAdapterFactory
  {
    ...
    {
      TypeToken localTypeToken = exactType;
      boolean bool;
      if (localTypeToken != null)
      {
        if ((!localTypeToken.equals(paramTypeToken)) && ((!matchRawType) || (exactType.getType() != paramTypeToken.getRawType()))) {
          bool = false;
        } else {
          bool = true;
        }
