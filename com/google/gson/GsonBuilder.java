...
public final class GsonBuilder
{
  ...
  GsonBuilder(Gson paramGson)
  {
    ...
    dateStyle = dateStyle;
    timeStyle = timeStyle;
    factories.addAll(builderFactories);
    hierarchyFactories.addAll(builderHierarchyFactories);
  }
  ...
  public Gson create()
  {
    ...
    return new Gson(excluder, fieldNamingPolicy, instanceCreators, serializeNulls, complexMapKeySerialization, generateNonExecutableJson, escapeHtmlChars, prettyPrinting, lenient, serializeSpecialFloatingPointValues, longSerializationPolicy, datePattern, dateStyle, timeStyle, factories, hierarchyFactories, localArrayList1);
  }
