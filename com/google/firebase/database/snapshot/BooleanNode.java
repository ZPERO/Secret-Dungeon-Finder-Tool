  ...
  extends LeafNode<BooleanNode>
{
  ...
  public BooleanNode(Boolean paramBoolean, Node paramNode)
  {
    super(paramNode);
    value = paramBoolean.booleanValue();
  }
  
  protected int compareLeafValues(BooleanNode paramBooleanNode)
  {
    boolean bool = value;
    if (bool == value) {
      return 0;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    paramObject = (BooleanNode)paramObject;
  ...
  public BooleanNode updatePriority(Node paramNode)
  {
    return new BooleanNode(Boolean.valueOf(value), paramNode);
  }
}
