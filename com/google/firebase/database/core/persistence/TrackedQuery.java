...
public class TrackedQuery
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      return (zoom == zoom) && (querySpec.equals(querySpec)) && (lastUse == lastUse) && (complete == complete) && (active == active);
    }
    return false;
  }
  ...
  public int hashCode()
  {
    return (((Long.valueOf(zoom).hashCode() * 31 + querySpec.hashCode()) * 31 + Long.valueOf(lastUse).hashCode()) * 31 + Boolean.valueOf(complete).hashCode()) * 31 + Boolean.valueOf(active).hashCode();
  }
  
  public TrackedQuery setActiveState(boolean paramBoolean)
  {
    return new TrackedQuery(zoom, querySpec, lastUse, complete, paramBoolean);
  }
  
  public TrackedQuery setComplete()
  {
    return new TrackedQuery(zoom, querySpec, lastUse, true, active);
  }
  ...
  {
    return new TrackedQuery(zoom, querySpec, paramLong, complete, active);
  }
}
