  ...
  implements zzcq
{
  ...
  private zzbt(zzcr paramZzcr)
  {
    ...
    zzapr.next(new zzbu(this, paramZzcr));
  }
  ...
  protected final void start()
  {
    ...
    else
    {
      ...
      {
        zzgm();
        if (zzfk.flush(zzgf().getGmpAppId(), zzgp().zzjs(), zzgf().zzgw(), zzgp().zzjt()))
        {
  ...
  {
    FileTransfer localFileTransfer = zzapy;
    if (localFileTransfer != null) {
  ...
  {
    zzap localZzap = zzapq;
    if ((localZzap != null) && (localZzap.isInitialized())) {
      return zzapq;
    }
    return null;
  }
  ...
  protected final boolean zzkr()
  {
    zzcl();
    zzgn().zzaf();
    Boolean localBoolean = zzaqe;
    if ((localBoolean == null) || (zzaqf == 0L) || ((localBoolean != null) && (!localBoolean.booleanValue()) && (Math.abs(zzrz.elapsedRealtime() - zzaqf) > 1000L)))
    {
      zzaqf = zzrz.elapsedRealtime();
      boolean bool1 = zzgm().checkVersion("android.permission.INTERNET");
      boolean bool2 = true;
      if ((bool1) && (zzgm().checkVersion("android.permission.ACCESS_NETWORK_STATE")) && ((Wrappers.packageManager(zzri).isCallerInstantApp()) || (zzapo.zzib()) || ((zzbj.isSystemApp(zzri)) && (zzfk.parse(zzri, false))))) {
        bool1 = true;
      } else {
        bool1 = false;
      }
      ...
      {
        bool1 = bool2;
        if (!zzgm().forEach(zzgf().getGmpAppId(), zzgf().zzgw())) {
