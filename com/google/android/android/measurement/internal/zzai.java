  ...
  implements zzag
{
    ...
    throws RemoteException
  {
    ...
    Log.writeString(localParcel, paramVideoItem);
    ...
    throws RemoteException
  {
    ...
    Log.writeString((android.os.Parcel)localObject, paramVideoItem);
    paramVideoItem = transactAndReadException(11, (android.os.Parcel)localObject);
    localObject = paramVideoItem.readString();
    paramVideoItem.recycle();
    return localObject;
  }
    ...
    throws RemoteException
  {
    ...
    paramVideoItem = transactAndReadException(7, (android.os.Parcel)localObject);
    localObject = paramVideoItem.createTypedArrayList(zzfh.CREATOR);
    paramVideoItem.recycle();
    return localObject;
  }
