  ...
  extends Log
{
  ...
  private final VideoItem e(boolean paramBoolean)
  {
    zzgr();
    zzaj localZzaj = zzgf();
    String str;
  ...
  protected final void resetAnalyticsData()
  {
    ...
    zzgb();
    zzcl();
    VideoItem localVideoItem = e(false);
    if (zzld()) {
      zzgi().resetAnalyticsData();
    }
    start(new zzdt(this, localVideoItem));
  }
  
  final void sendRequest(zzag paramZzag, AbstractSafeParcelable paramAbstractSafeParcelable, VideoItem paramVideoItem)
  {
    zzaf();
    zzgb();
    zzcl();
    ...
    while ((j < 1001) && (i == 100))
    {
      ...
      while (k < m)
      {
        ...
        if ((localObject instanceof zzad))
        {
          ...
          try
          {
            paramZzag.handleResult((zzad)localObject, paramVideoItem);
          }
        ...
        else if ((localRemoteException1 instanceof zzfh))
        {
          ...
          try
          {
            paramZzag.write(localZzfh, paramVideoItem);
          }
        ...
        else if ((localRemoteException2 instanceof ComponentInfo))
        {
          ...
          try
          {
            paramZzag.getPackageInfo(localComponentInfo, paramVideoItem);
          }
  ...
  protected final void url(zzad paramZzad, String paramString)
  {
