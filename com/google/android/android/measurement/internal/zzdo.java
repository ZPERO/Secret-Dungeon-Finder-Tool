  ...
  extends Log
{
  ...
  public static void d(zzdn paramZzdn, Bundle paramBundle, boolean paramBoolean)
  {
  ...
  private final void persist(Activity paramActivity, zzdn paramZzdn, boolean paramBoolean)
  {
    ...
    zzarq = zzarp;
    zzarp = localZzdn2;
    zzgn().next(new zzdp(this, paramBoolean, localZzdn1, localZzdn2));
  }
  ...
  public final void onActivityPaused(Activity paramActivity)
  {
    ...
    zzarq = zzarp;
    zzarp = null;
    zzgn().next(new zzdq(this, paramActivity));
  }
  ...
  public final void onActivityResumed(Activity paramActivity)
  {
    ...
    paramActivity.zzgn().next(new IonBitmapRequestBuilder.1(paramActivity, l));
  }
