  ...
  extends Log
{
  ...
  final VideoItem zzbr(String paramString)
  {
    zzaf();
    zzgb();
    String str2 = zzal();
    ...
    localObject = ((class_1)localObject).zzau("google_analytics_adid_collection_enabled");
    boolean bool1;
    ...
    localObject = zzgq();
    ((zzco)localObject).zzgb();
    localObject = ((class_1)localObject).zzau("google_analytics_ssaid_collection_enabled");
    if ((localObject != null) && (!((Boolean)localObject).booleanValue())) {
      bool1 = false;
    } else {
      bool1 = true;
    }
    return new VideoItem(str2, str3, str4, l1, str5, l2, l3, paramString, bool2, bool3 ^ true, str1, l4, l5, i, bool4, Boolean.valueOf(bool1).booleanValue(), zzgp().zzjx(), zzgw());
  }
