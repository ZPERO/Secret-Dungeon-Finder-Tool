  ...
  public final void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.android.vending.INSTALL_REFERRER".equals(localObject1))
    {
      try
      {
        ...
        ((zzbo)localObject1).next(new zzbk(this, localZzbt, localZzap));
      }
      ...
      else
      {
        ...
        else
        {
          ...
          localZzbt.zzgn().next(new zzbl(this, localZzbt, l, (Bundle)localObject2, paramContext, localZzap, localPendingResult));
        }
      }
    }
  }
