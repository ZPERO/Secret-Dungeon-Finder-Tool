...
final class zzdu
  implements Runnable
{
  zzdu(zzdr paramZzdr, AtomicReference paramAtomicReference, VideoItem paramVideoItem) {}
  ...
  public final void run()
  {
    ...
    ((AtomicReference)localObject2).set(((zzag)localObject1).getAbsoluteUrl(localVideoItem));
    localObject1 = zzash;
    ...
    {
      localObject2 = zzasg;
      ((class_4)localObject2).zzge().zzcm((String)localObject1);
      localObject2 = zzasg;
