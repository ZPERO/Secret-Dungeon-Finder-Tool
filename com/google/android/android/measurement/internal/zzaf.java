...
public final class zzaf
{
  ...
  public final class zza<V>
  {
    ...
    static zza query(String paramString, double paramDouble1, double paramDouble2)
    {
      ...
      paramString = new zza(paramString, localDouble, localDouble);
    ...
    private static void zzix()
    {
      ...
      //   0: ldc 64
      //   2: monitorenter
      //   3: invokestatic 162	com/google/android/android/measurement/internal/MultiMap:isMainThread	()Z
      //   6: ifne +276 -> 282
      //   9: getstatic 86	com/google/android/android/measurement/internal/zzaf:zzaiq	Lcom/google/android/android/measurement/internal/MultiMap;
      //   12: astore_1
      //   13: getstatic 43	com/google/android/android/measurement/internal/zzaf:zzait	Ljava/util/List;
      //   16: astore_1
      //   17: aload_1
      ...
      //   46: astore_2
      //   47: aload_2
      //   48: getfield 97	com/google/android/android/measurement/internal/zzaf$zza:zzall	Lcom/google/android/android/internal/measurement/zzsl;
      //   51: astore_3
      //   52: aload_3
      //   53: invokevirtual 167	com/google/android/android/internal/measurement/zzsl:unwrap	()Ljava/lang/Object;
      //   56: astore_3
      //   57: aload_2
      //   58: aload_3
      //   59: putfield 169	com/google/android/android/measurement/internal/zzaf$zza:zzaln	Ljava/lang/Object;
      //   62: goto -38 -> 24
      //   65: getstatic 100	com/google/android/android/measurement/internal/zzaf:zzaiu	Ljava/util/List;
      //   68: astore_1
      //   69: aload_1
      ...
      //   98: astore_2
      //   99: aload_2
      //   100: getfield 97	com/google/android/android/measurement/internal/zzaf$zza:zzall	Lcom/google/android/android/internal/measurement/zzsl;
      //   103: astore_3
      //   104: aload_3
      //   105: invokevirtual 167	com/google/android/android/internal/measurement/zzsl:unwrap	()Ljava/lang/Object;
      //   108: astore_3
      //   109: aload_2
      //   110: aload_3
      //   111: putfield 169	com/google/android/android/measurement/internal/zzaf$zza:zzaln	Ljava/lang/Object;
      //   114: goto -38 -> 76
      //   117: getstatic 109	com/google/android/android/measurement/internal/zzaf:zzais	Ljava/util/List;
      //   120: astore_1
      //   121: aload_1
      ...
      //   136: ifeq +33 -> 169
      //   139: aload_1
      //   140: invokeinterface 78 1 0
      //   145: astore_2
      //   146: aload_2
      //   147: checkcast 2	com/google/android/android/measurement/internal/zzaf$zza
      //   150: astore_2
      //   151: aload_2
      //   152: getfield 97	com/google/android/android/measurement/internal/zzaf$zza:zzall	Lcom/google/android/android/internal/measurement/zzsl;
      //   155: astore_3
      //   156: aload_3
      //   157: invokevirtual 167	com/google/android/android/internal/measurement/zzsl:unwrap	()Ljava/lang/Object;
      //   160: astore_3
      //   161: aload_2
      //   162: aload_3
      //   163: putfield 169	com/google/android/android/measurement/internal/zzaf$zza:zzaln	Ljava/lang/Object;
      //   166: goto -38 -> 128
      //   169: getstatic 59	com/google/android/android/measurement/internal/zzaf:zzair	Ljava/util/List;
      //   172: astore_1
      //   173: aload_1
      //   174: invokeinterface 68 1 0
      //   179: astore_1
      //   180: aload_1
      //   181: invokeinterface 74 1 0
      //   186: istore_0
      //   187: iload_0
      //   188: ifeq +33 -> 221
      //   191: aload_1
      ...
      //   202: astore_2
      //   203: aload_2
      //   204: getfield 97	com/google/android/android/measurement/internal/zzaf$zza:zzall	Lcom/google/android/android/internal/measurement/zzsl;
      //   207: astore_3
      //   208: aload_3
      //   209: invokevirtual 167	com/google/android/android/internal/measurement/zzsl:unwrap	()Ljava/lang/Object;
      //   212: astore_3
      //   213: aload_2
      //   214: aload_3
      //   215: putfield 169	com/google/android/android/measurement/internal/zzaf$zza:zzaln	Ljava/lang/Object;
      //   218: goto -38 -> 180
      //   221: getstatic 130	com/google/android/android/measurement/internal/zzaf:zzaiv	Ljava/util/List;
      //   224: astore_1
      //   225: aload_1
      //   226: invokeinterface 68 1 0
      //   231: astore_1
      //   232: aload_1
      //   233: invokeinterface 74 1 0
      //   238: istore_0
      //   239: iload_0
      //   240: ifeq +38 -> 278
      //   243: aload_1
      //   244: invokeinterface 78 1 0
      //   249: astore_2
      //   250: aload_2
      //   251: checkcast 2	com/google/android/android/measurement/internal/zzaf$zza
      //   254: astore_2
      //   255: aload_2
      //   256: getfield 97	com/google/android/android/measurement/internal/zzaf$zza:zzall	Lcom/google/android/android/internal/measurement/zzsl;
      //   259: astore_3
      //   260: aload_3
      //   261: invokevirtual 167	com/google/android/android/internal/measurement/zzsl:unwrap	()Ljava/lang/Object;
      //   264: astore_3
      //   265: aload_2
      //   266: aload_3
      //   267: putfield 169	com/google/android/android/measurement/internal/zzaf$zza:zzaln	Ljava/lang/Object;
      //   270: goto -38 -> 232
      //   273: astore_1
      //   274: aload_1
      //   275: invokestatic 173	com/google/android/android/measurement/internal/zzaf:getDefaultValue	(Ljava/lang/Exception;)V
      //   278: ldc 64
      //   280: monitorexit
      //   281: return
      //   282: new 175	java/lang/IllegalStateException
      //   285: dup
      //   286: ldc -79
      //   288: invokespecial 180	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
      //   291: athrow
      //   292: astore_1
      //   293: ldc 64
      //   295: monitorexit
      ...
      //   292	8	1	localThrowable	Throwable
