  ...
  extends class_4
{
  ...
  private final void getOffset(long paramLong, zzdn paramZzdn)
  {
    if (paramZzdn == null)
    {
    ...
    zzdo.d(paramZzdn, localBundle, true);
    zzge().logEvent("am", "_xa", localBundle);
  }
  
  private final void getOffset(String paramString, long paramLong, zzdn paramZzdn)
  {
    if (paramZzdn == null)
    {
    ...
    if (localObject != null)
    {
      ...
      if (i == 0)
      {
        ...
        else
        {
          ...
          getOffset(paramString, paramLong - l, localZzdn);
        }
        if (zzafr.isEmpty())
        {
          l = zzafs;
          ...
          getOffset(paramLong - l, localZzdn);
          zzafs = 0L;
        }
      }
      else
  ...
  public final void beginAdUnitExposure(String paramString, long paramLong)
  {
    ...
    {
      zzgn().next(new FileBrowser.11(this, paramString, paramLong));
      return;
    }
  ...
  public final void endAdUnitExposure(String paramString, long paramLong)
  {
    if ((paramString != null) && (paramString.length() != 0))
    {
      zzgn().next(new LayerView.1(this, paramString, paramLong));
      return;
    }
    zzgo().zzjd().zzbx("Ad unit id must be a non-empty string");
  }
  ...
  public final void upload(long paramLong)
  {
    ...
    {
      String str = (String)localIterator.next();
      getOffset(str, paramLong - ((Long)zzafq.get(str)).longValue(), localZzdn);
    }
    if (!zzafq.isEmpty()) {
      getOffset(paramLong - zzafs, localZzdn);
    }
    execute(paramLong);
  }
}
