  ...
  implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener
{
  ...
  public final void onConnected(Bundle paramBundle)
  {
    ...
    catch (Throwable paramBundle)
    {
      try
      {
        ...
        ((zzbo)localObject).next(new zzei(this, paramBundle));
      }
  ...
  public final void onServiceDisconnected(ComponentName paramComponentName)
  {
    ...
    zzasg.zzgn().next(new zzeh(this, paramComponentName));
  }
  ...
  public final void zzlh()
  {
    ...
    try
    {
      ...
      if ((zzasn != null) && ((!class_1.zzia()) || (zzasn.isConnecting()) || (zzasn.isConnected())))
      {
