...
public final class zzel<T extends Context,  extends zzep>
{
  ...
  private final void removeTask(Runnable paramRunnable)
  {
    zzfa localZzfa = zzfa.add(zzaby);
    localZzfa.zzgn().next(new zzeo(this, localZzfa, paramRunnable));
  }
  ...
  public final int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    if ("com.google.android.gms.measurement.UPLOAD".equals(str)) {
      removeTask(new zzem(this, paramInt2, localZzap, paramIntent));
    }
    return 2;
  }
  ...
  public final boolean onStartJob(JobParameters paramJobParameters)
  {
    ...
    if ("com.google.android.gms.measurement.UPLOAD".equals(str)) {
      removeTask(new zzen(this, localZzap, paramJobParameters));
    }
    return true;
  }
