  ...
  extends Log
{
  ...
  private final void d(String paramString1, String paramString2, long paramLong, Object paramObject)
  {
    zzgn().next(new zzcv(this, paramString1, paramString2, paramObject, paramLong));
  }
  
  private final void download(String paramString1, String paramString2, long paramLong, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString3)
  {
    ...
    if (paramBoolean3)
    {
      ...
      if (!"_iap".equals(paramString2))
      {
        ...
        if (i != 0)
        {
          ...
          zzadj.zzgm().addMenuItem(i, "_ev", paramString1, j);
          return;
        }
      }
    }
    zzgr();
    localObject5 = zzgh().zzla();
    if ((localObject5 != null) && (!paramBundle.containsKey("_sc"))) {
      zzarn = true;
    }
    ...
    zzdo.d((zzdn)localObject5, paramBundle, bool1);
    ...
    if ((localBundle1 != null) && (localBundle1.containsKey("_sc")) && (localBundle1.containsKey("_si"))) {
      localObject3 = new zzdn(localBundle1.getString("_sn"), localBundle1.getString("_sc"), Long.valueOf(localBundle1.getLong("_si")).longValue());
    } else {
      localObject3 = null;
    }
    ...
    ((List)localObject5).add(localBundle1);
    ...
    while (i < m)
    {
      ...
      Object localObject6 = localBundle1.get((String)localObject3);
      zzgm();
      localObject6 = zzfk.get(localObject6);
      if (localObject6 != null)
      {
        localBundle1.putInt((String)localObject3, localObject6.length);
        k = 0;
        while (k < localObject6.length)
        {
          Bundle localBundle2 = localObject6[k];
          zzdo.d((zzdn)localObject2, localBundle2, true);
          localBundle2 = zzgm().parse(paramString3, "_ep", localBundle2, (List)localObject4, paramBoolean3, false);
          localBundle2.putString("_en", paramString2);
          localBundle2.putLong("_eid", l);
          localBundle2.putString("_gn", (String)localObject3);
          localBundle2.putInt("_ll", localObject6.length);
          localBundle2.putInt("_i", k);
          ((List)localObject5).add(localBundle2);
          k += 1;
        }
    ...
    {
      localObject4 = (Bundle)((List)localObject5).get(i);
      if (i != 0) {
        j = 1;
      } else {
        j = 0;
      ...
      ((Bundle)localObject4).putString(paramBundle, paramString1);
      localObject2 = localObject4;
      if (paramBoolean2) {
        localObject2 = zzgm().getHeaders((Bundle)localObject4);
      }
      ...
      zzgg().url((zzad)localObject3, paramString3);
      if (!bool1)
      {
  ...
  private final void e(String paramString1, String paramString2, long paramLong, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString3)
  {
    ...
    zzgn().next(new zzcu(this, paramString1, paramString2, paramLong, paramBundle, paramBoolean1, paramBoolean2, paramBoolean3, paramString3));
  }
  ...
  private final List getHeaders(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      zzadj.zzgn().next(new zzdc(this, (AtomicReference)localObject, paramString1, paramString2, paramString3));
      try
      {
  ...
  private final Map getHeaders(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    try
    {
      zzadj.zzgn().next(new zzde(this, localAtomicReference, paramString1, paramString2, paramString3, paramBoolean));
      try
      {
  ...
  private final void recv(AppMeasurement.ConditionalUserProperty paramConditionalUserProperty)
  {
    ...
    Object localObject2 = zzgm().valueOf(str, localObject1);
    ...
    {
      zzgn().next(new zzda(this, paramConditionalUserProperty));
      return;
    }
    zzgo().zzjd().append("Invalid conditional user property time to live", zzgl().zzbu(str), Long.valueOf(l));
  }
  
  private final void resetData(String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    long l = zzbx().currentTimeMillis();
    Preconditions.checkNotEmpty(paramString2);
    ...
    zzgn().next(new zzdb(this, localConditionalUserProperty));
  }
  ...
  private final String zzak(long paramLong)
  {
    ...
    try
    {
      zzgn().next(new zzcy(this, localAtomicReference));
    }
  ...
  final void attribute(String paramString1, String paramString2, long paramLong, Bundle paramBundle)
  {
    ...
    download(paramString1, paramString2, paramLong, paramBundle, true, bool, false, null);
  }
  ...
  final void attribute(String paramString1, String paramString2, Object paramObject, long paramLong)
  {
        ...
        if (!"auto".equals(paramString1))
        {
          if ((paramObject instanceof String))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              ...
              localObject1 = "true";
              long l;
              if ((!"true".equals(localObject2)) && (!"1".equals(paramObject))) {
                l = 0L;
              } else {
                l = 1L;
              }
              ...
              localZzbf.zzcc((String)localObject1);
              localObject1 = paramObject;
              break label245;
            }
          }
    ...
    zzgo().zzjk().append("Setting user property (FE)", zzgl().zzbs(paramString2), localObject1);
    paramString1 = new zzfh(paramString2, paramLong, localObject1, paramString1);
  ...
  {
    zzgb();
    resetData(null, paramString1, paramString2, paramBundle);
  }
  ...
  public final void clearConditionalUserPropertyAs(String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    Preconditions.checkNotEmpty(paramString1);
    zzga();
    resetData(paramString1, paramString2, paramString3, paramBundle);
  }
  
  public final void create(String paramString1, String paramString2, Object paramObject, boolean paramBoolean, long paramLong)
  {
    ...
    if (paramObject != null)
    {
      ...
      if (k != 0)
      {
        ...
        zzadj.zzgm().addMenuItem(k, "_ev", paramString1, i);
        return;
      }
      paramString1 = zzgm().valueOf(paramString2, paramObject);
      if (paramString1 != null) {
        d(str, paramString2, paramLong, paramString1);
      }
    }
    else
    {
      d(str, paramString2, paramLong, null);
    }
  }
  ...
  public final void e(boolean paramBoolean)
  {
    zzcl();
    zzgb();
    zzgn().next(new zzdj(this, paramBoolean));
  }
  ...
  public final List getHeaders(boolean paramBoolean)
  {
    ...
    try
    {
      zzadj.zzgn().next(new zzcx(this, (AtomicReference)localObject, paramBoolean));
      try
      {
        localObject.wait(5000L);
      }
  ...
  public final void log(String paramString1, String paramString2, Object paramObject, boolean paramBoolean)
  {
    create(paramString1, paramString2, paramObject, paramBoolean, zzbx().currentTimeMillis());
  }
  ...
  public final void resetAnalyticsData(long paramLong)
  {
    ...
    zzgn().next(new zzcz(this, paramLong));
  }
  ...
  public final void setConditionalUserProperty(AppMeasurement.ConditionalUserProperty paramConditionalUserProperty)
  {
    ...
    mAppId = null;
    recv(paramConditionalUserProperty);
  }
  ...
  public final void setConditionalUserPropertyAs(AppMeasurement.ConditionalUserProperty paramConditionalUserProperty)
  {
    ...
    zzga();
    recv(new AppMeasurement.ConditionalUserProperty(paramConditionalUserProperty));
  }
  ...
  public final void setEventInterceptor(AppMeasurement.EventInterceptor paramEventInterceptor)
  {
    ...
    {
      AppMeasurement.EventInterceptor localEventInterceptor = zzaqw;
