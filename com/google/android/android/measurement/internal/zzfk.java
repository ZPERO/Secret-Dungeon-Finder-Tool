  ...
  extends zzcp
{
  ...
  private static boolean evaluate(Context paramContext, String paramString)
  {
    try
    {
  ...
  static boolean flush(String paramString1, String paramString2, String paramString3, String paramString4)
  {
  ...
  static boolean parse(Context paramContext, boolean paramBoolean)
  {
    Preconditions.checkNotNull(paramContext);
    if (Build.VERSION.SDK_INT >= 24) {
      return evaluate(paramContext, "com.google.android.gms.measurement.AppMeasurementJobService");
    }
    return evaluate(paramContext, "com.google.android.gms.measurement.AppMeasurementService");
  }
  ...
  public static Object put(Object paramObject)
  {
    ...
    //   4: aconst_null
    //   5: areturn
    //   6: new 336	java/io/ByteArrayOutputStream
    //   9: dup
    //   10: invokespecial 338	java/io/ByteArrayOutputStream:<init>	()V
    //   13: astore_1
    //   14: new 340	java/io/ObjectOutputStream
    //   17: dup
    //   18: aload_1
    //   19: invokespecial 343	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   22: astore_2
    //   23: aload_2
    //   24: aload_0
    //   25: invokevirtual 347	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   28: aload_2
    //   29: invokevirtual 349	java/io/ObjectOutputStream:flush	()V
    //   32: new 351	java/io/ObjectInputStream
    //   35: dup
    //   36: new 256	java/io/ByteArrayInputStream
    //   39: dup
    //   40: aload_1
    //   41: invokevirtual 352	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   44: invokespecial 265	java/io/ByteArrayInputStream:<init>	([B)V
    //   47: invokespecial 355	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   50: astore_0
    //   51: aload_0
    //   52: invokevirtual 359	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   55: astore_1
    //   56: aload_2
    //   57: invokevirtual 362	java/io/ObjectOutputStream:close	()V
    //   60: aload_0
    //   61: invokevirtual 363	java/io/ObjectInputStream:close	()V
    //   64: aload_1
    //   65: areturn
    //   66: astore_1
    //   67: goto +14 -> 81
    ...
    //   82: ifnull +7 -> 89
    //   85: aload_2
    //   86: invokevirtual 362	java/io/ObjectOutputStream:close	()V
    //   89: aload_0
    //   90: ifnull +7 -> 97
    //   93: aload_0
    //   94: invokevirtual 363	java/io/ObjectInputStream:close	()V
    //   97: aload_1
    //   98: athrow
    //   99: astore_0
    //   100: aconst_null
  ...
  public final void addMenuItem(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
  ...
  final zzad e(String paramString1, String paramString2, Bundle paramBundle, String paramString3, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (zzcr(paramString2) == 0)
    {
      ...
      return new zzad(paramString2, new zzaa(getHeaders(parse(paramString1, paramString2, paramBundle, CollectionUtils.listOf("_o"), false, false))), paramString3, paramLong);
    }
    zzgo().zzjd().append("Invalid conditional property event name", zzgl().zzbu(paramString2));
    throw new IllegalArgumentException();
  }
  
  final boolean forEach(String paramString1, String paramString2)
  {
  ...
  final Bundle getHeaders(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        Object localObject = getValue(str, paramBundle.get(str));
        if (localObject == null) {
  ...
  final Object getValue(String paramString, Object paramObject)
  {
  ...
  final Object valueOf(String paramString, Object paramObject)
  {
    if ("_ldl".equals(paramString)) {
