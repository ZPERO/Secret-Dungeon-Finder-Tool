...
class Message
{
  ...
  static Message create(String paramString, Throwable paramThrowable)
  {
    return new Message(false, paramString, paramThrowable);
  }
  
  static Message create(Callable paramCallable)
  {
  ...
  static String toString(String paramString, Name paramName, boolean paramBoolean1, boolean paramBoolean2)
  {
    String str;
    if (paramBoolean2) {
    ...
    return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", new Object[] { str, paramString, IpAddress.toString(AndroidUtilsLight.getInstance("SHA-1").digest(paramName.getBytes())), Boolean.valueOf(paramBoolean1), "12451009.false" });
  }
