...
public class GoogleSignatureVerifier
{
  ...
  public static boolean backup(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    ...
    {
      if (paramBoolean) {
        paramPackageInfo = toString(paramPackageInfo, DataProvider.TAG);
      } else {
        paramPackageInfo = toString(paramPackageInfo, new Name[] { DataProvider.TAG[0] });
      }
  ...
  private final Message toString(PackageInfo paramPackageInfo)
  {
    ...
    TypedByteArray localTypedByteArray = new TypedByteArray(signatures[0].toByteArray());
    String str = packageName;
    Message localMessage2 = Profile.read(str, localTypedByteArray, bool);
  ...
  private static Name toString(PackageInfo paramPackageInfo, Name... paramVarArgs)
  {
    if (signatures == null) {
      return null;
    }
    ...
    int i = 0;
    paramPackageInfo = new TypedByteArray(paramPackageInfo[0].toByteArray());
