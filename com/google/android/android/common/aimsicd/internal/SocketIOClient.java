  ...
  implements zabs
{
  ...
  private SocketIOClient(Context paramContext, zaaw paramZaaw, Lock paramLock, Looper paramLooper, GoogleApiAvailabilityLight paramGoogleApiAvailabilityLight, Map paramMap1, Map paramMap2, ClientSettings paramClientSettings, Api.AbstractClientBuilder paramAbstractClientBuilder, Api.Client paramClient, ArrayList paramArrayList1, ArrayList paramArrayList2, Map paramMap3, Map paramMap4)
  {
    ...
    zabj = paramLooper;
    zaei = paramClient;
    zaee = new zabe(paramContext, zaed, paramLock, paramLooper, paramGoogleApiAvailabilityLight, paramMap2, null, paramMap4, null, paramArrayList2, new Exec(this, null));
    zaef = new zabe(paramContext, zaed, paramLock, paramLooper, paramGoogleApiAvailabilityLight, paramMap1, paramClientSettings, paramMap3, paramAbstractClientBuilder, paramArrayList1, new StateMachine(this, null));
  ...
  private final void reconnect()
  {
    ...
    else
    {
      ...
      localConnectionResult = zaek;
      if ((localConnectionResult != null) && (zael != null))
      {
