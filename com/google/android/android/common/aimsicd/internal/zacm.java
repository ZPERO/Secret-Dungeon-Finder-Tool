  ...
  implements ResultCallback<R>
{
  ...
  private final void zabu()
  {
    ...
    Object localObject = (com.google.android.android.common.aimsicd.GoogleApiClient)zadp.get();
    if ((!zakt) && (zakn != null) && (localObject != null))
    {
      ((com.google.android.android.common.aimsicd.GoogleApiClient)localObject).ensureInitialized(this);
      zakt = true;
    }
    localObject = zakr;
    if (localObject != null)
    ...
    localObject = zakq;
    if (localObject != null) {
      ((com.google.android.android.common.aimsicd.PendingResult)localObject).setResultCallback(this);
    }
  }
