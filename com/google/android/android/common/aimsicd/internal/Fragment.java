...
public final class Fragment
  extends androidx.fragment.package_8.Fragment
  implements LifecycleFragment
{
  private static WeakHashMap<androidx.fragment.app.FragmentActivity, WeakReference<zzc>> zzbd = new WeakHashMap();
  ...
  public static Fragment getFragment(androidx.fragment.package_8.FragmentActivity paramFragmentActivity)
  {
    ...
    try
    {
      ...
      else
      {
        ...
        paramFragmentActivity.getSupportFragmentManager().beginTransaction().add((androidx.fragment.package_8.Fragment)localObject, "SupportLifecycleFragmentImpl").commitAllowingStateLoss();
      }
