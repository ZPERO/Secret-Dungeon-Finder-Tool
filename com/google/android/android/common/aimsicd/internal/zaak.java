  ...
  implements zabd
{
  ...
  {
    Client localClient = zaga;
    if (localClient != null)
    {
      if ((localClient.isConnected()) && (paramBoolean)) {
        zaga.zacv();
      }
      zaga.disconnect();
      zage = null;
  ...
  private final void zaaq()
  {
    ...
    {
      if (zagf) {
        ((Client)localObject).disconnect(zage, zagg);
      }
      putChannel(false);
    }
  ...
  public final void begin()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = (Api.Client)zafs.zagy.get(((Sample)localObject2).getClientKey());
      int j;
      if (((Sample)localObject2).getValue().getPriority() == 1) {
        j = 1;
      } else {
        j = 0;
      }
      ...
      if (((Api.Client)localObject3).requiresSignIn())
      {
        zagc = true;
        if (bool) {
          zafz.add(((Sample)localObject2).getClientKey());
        } else {
          zagb = false;
        }
      }
      localHashMap.put(localObject3, new zaam(this, (Sample)localObject2, bool));
    }
    if (i != 0) {
      zagc = false;
    }
    if (zagc)
    {
      ...
      zaga = ((Client)((com.google.android.android.common.aimsicd.Api.AbstractClientBuilder)localObject2).buildClient((Context)localObject3, localLooper, localClientSettings, localClientSettings.getSignInOptions(), (GoogleApiClient.ConnectionCallbacks)localObject1, (GoogleApiClient.OnConnectionFailedListener)localObject1));
    }
    zafx = zafs.zagy.size();
