...
public class ProcessUtils
{
  ...
  private static String read(int paramInt)
  {
    ...
    //   11: dup
    //   12: bipush 25
    //   14: invokespecial 62	java/lang/StringBuilder:<init>	(I)V
    //   17: astore_1
    //   18: aload_1
    //   19: ldc 64
    ...
    //   25: aload_1
    //   26: iload_0
    //   27: invokevirtual 71	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   30: pop
    //   31: aload_1
    //   32: ldc 73
    ...
    //   42: invokestatic 78	com/google/android/android/common/util/ProcessUtils:open	(Ljava/lang/String;)Ljava/io/BufferedReader;
    //   45: astore_1
    //   46: aload_1
    //   47: astore_2
    //   48: aload_1
    //   49: invokevirtual 81	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   52: invokevirtual 86	java/lang/String:trim	()Ljava/lang/String;
    //   55: astore_3
    //   56: aload_1
    //   57: invokestatic 92	com/google/android/android/common/util/IOUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   60: aload_3
    //   61: areturn
    //   62: astore_2
    //   63: goto +6 -> 69
    ...
    //   68: astore_1
    //   69: aload_1
    //   70: invokestatic 92	com/google/android/android/common/util/IOUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   73: aload_2
    //   74: athrow
    //   75: aconst_null
    //   76: astore_2
    //   77: aload_2
    //   78: invokestatic 92	com/google/android/android/common/util/IOUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   81: aconst_null
    //   82: areturn
    //   83: astore_1
    //   84: goto -9 -> 75
