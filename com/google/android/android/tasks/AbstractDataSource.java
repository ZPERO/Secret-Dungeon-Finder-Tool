  ...
  extends com.google.android.gms.tasks.Task<TResult>
{
  ...
  {
    paramOnCanceledListener = new SyncCampaign(TaskExecutors.MAIN_THREAD, paramOnCanceledListener);
  ...
  {
    unpackedObjectCache.add(new SyncCampaign(paramExecutor, paramOnCanceledListener));
    startLoader();
    return this;
  }
  ...
  {
    paramOnCompleteListener = new MediaSessionCompat.MediaSessionImplBase(TaskExecutors.MAIN_THREAD, paramOnCompleteListener);
  ...
  {
    unpackedObjectCache.add(new MediaSessionCompat.MediaSessionImplBase(paramExecutor, paramOnCompleteListener));
    startLoader();
    return this;
  }
