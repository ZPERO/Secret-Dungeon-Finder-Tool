  ...
  implements zzvs<Float>, zzxe, RandomAccess
{
    ...
    if (paramInt >= 0)
    {
      ...
      if (paramInt <= i)
      {
        ...
        else
        {
          ...
          System.arraycopy(zzbyj, paramInt, arrayOfFloat2, paramInt + 1, size - paramInt);
          zzbyj = arrayOfFloat2;
        }
  ...
  public final boolean addAll(Collection paramCollection)
  {
    ...
    {
      i = j + i;
      float[] arrayOfFloat = zzbyj;
      if (i > arrayOfFloat.length) {
        zzbyj = Arrays.copyOf(arrayOfFloat, i);
      }
