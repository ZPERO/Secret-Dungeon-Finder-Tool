...
public final class zzsi
{
  ...
  {
    // Byte code:
    //   0: new 31	java/util/HashMap
    //   3: dup
    //   4: invokespecial 32	java/util/HashMap:<init>	()V
    //   7: astore_2
    //   8: aload_0
    //   9: getfield 55	com/google/android/android/internal/measurement/zzsi:zzbqr	Landroid/content/ContentResolver;
    //   12: astore_3
    //   13: aload_0
    //   14: getfield 57	com/google/android/android/internal/measurement/zzsi:sourceName	Landroid/net/Uri;
    //   17: astore 4
    //   19: getstatic 42	com/google/android/android/internal/measurement/zzsi:zzbqw	[Ljava/lang/String;
    //   22: astore 5
    //   24: aload_3
    //   25: aload 4
    //   27: aload 5
    ...
    //   30: aconst_null
    //   31: aconst_null
    //   32: invokevirtual 99	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   35: astore_3
    //   36: aload_3
    //   37: ifnull +81 -> 118
    //   40: aload_3
    ...
    //   59: aload_3
    //   60: iconst_1
    //   61: invokeinterface 109 2 0
    //   66: invokeinterface 84 3 0
    //   71: pop
    //   72: goto -32 -> 40
    //   75: aload_3
    ...
    //   83: astore_2
    //   84: aload_3
    //   85: invokeinterface 112 1 0
    //   90: aload_2
    //   91: athrow
    //   92: ldc 114
    //   94: ldc 116
    //   96: invokestatic 122	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   99: pop
    //   100: aconst_null
    //   101: areturn
    //   102: astore_2
