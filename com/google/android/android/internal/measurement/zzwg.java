  ...
  extends zzwd
{
  ...
  private static zzvs of(Object paramObject, long paramLong)
  {
    return (zzvs)zzyh.get(paramObject, paramLong);
  }
  
  final List get(Object paramObject, long paramLong)
  {
    zzvs localZzvs2 = of(paramObject, paramLong);
  ...
  {
    of(paramObject, paramLong).zzsm();
  }
  
  final void visitTypeInsn(Object paramObject1, Object paramObject2, long paramLong)
  {
    zzvs localZzvs2 = of(paramObject1, paramLong);
    zzvs localZzvs1 = localZzvs2;
    zzvs localZzvs3 = of(paramObject2, paramLong);
