  ...
  extends zzzg
{
    ...
    throws IOException
  {
    ...
    paramZzyx = null;
    Object localObject = zzcfc;
    if (localObject == null) {
      zzcfc = new zzzc();
    } else {
      paramZzyx = ((zzzc)localObject).zzcb(j);
    }
    localObject = paramZzyx;
    if (paramZzyx == null)
    {
  ...
  public final Object readLong(zzzb paramZzzb)
  {
    ...
    localObject = ((zzzc)localObject).zzcb(size >>> 3);
    if (localObject == null) {
      return null;
    }
    return ((zzzd)localObject).readLong(paramZzzb);
  }
}
