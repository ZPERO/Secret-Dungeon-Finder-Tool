...
final class zzyh
{
  ...
  {
    return (byte)(getName(paramObject, 0xFFFFFFFFFFFFFFFC & paramLong) >>> (int)((paramLong & 0x3) << 3));
  }
  
  private static void add(Object paramObject, long paramLong, byte paramByte)
  {
    long l = 0xFFFFFFFFFFFFFFFC & paramLong;
    int i = getName(paramObject, l);
    int j = ((int)paramLong & 0x3) << 3;
    trim(paramObject, l, (0xFF & paramByte) << j | i & 255 << j);
  }
  
  static void add(Object paramObject, long paramLong, double paramDouble)
  {
    zzccx.writeDouble(paramObject, paramLong, paramDouble);
  }
  
  static void add(Object paramObject, long paramLong, float paramFloat)
  {
  ...
  static double doubleValue(Object paramObject, long paramLong)
  {
  ...
  static int getName(Object paramObject, long paramLong)
  {
    return zzccx.readInt(paramObject, paramLong);
  }
  
  static boolean getValue(Object paramObject, long paramLong)
  {
    return zzccx.get(paramObject, paramLong);
  }
  
  static long next(Object paramObject, long paramLong)
  {
    return zzccx.f(paramObject, paramLong);
  }
  
  static long next(ByteBuffer paramByteBuffer)
  {
    return zzccx.f(paramByteBuffer, zzcdm);
  }
  ...
  static float substring(Object paramObject, long paramLong)
  {
  ...
  static byte toString(byte[] paramArrayOfByte, long paramLong)
  {
    return zzccx.readByte(paramArrayOfByte, zzccz + paramLong);
  }
  
  static void trim(Object paramObject, long paramLong, int paramInt)
  {
    ...
    extends zzyh.zzd
  {
    ...
    {
      if (zzyh.zzvh()) {
        return zzyh.reduce(paramObject, paramLong);
      }
  ...
  abstract class zzd
  {
    ...
    {
      return getInt(paramObject, paramLong);
    }
