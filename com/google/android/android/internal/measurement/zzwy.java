  ...
  implements zzxj<T>
{
    ...
    throws IOException
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((localZzvf.zzvx() == zzyv.zzcet) && (!localZzvf.zzvy()) && (!localZzvf.zzvz()))
      {
        if ((localEntry instanceof zzvy)) {
          paramZzyw.f(localZzvf.next(), ((zzvy)localEntry).zzwu().zztt());
        } else {
          paramZzyw.f(localZzvf.next(), localEntry.getValue());
        }
      }
      else {
    ...
    localObject = zzcbn;
    ((zzyb)localObject).element(((zzyb)localObject).zzah(paramObject), paramZzyw);
  }
      ...
      do
      {
        ...
        if (i != 11)
        {
          if ((i & 0x7) == 2)
          {
            ...
            {
              localZzva.setProperty(paramZzxi, localObject1, paramZzuz, localZzvd);
            }
            else
            {
        ...
        else
        {
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                if (localObject2 != null) {
                  localZzva.setProperty(paramZzxi, localObject2, paramZzuz, localZzvd);
                } else {
          ...
          if (localObject1 != null) {
            if (localObject2 != null) {
              localZzva.setProperty((zzud)localObject1, localObject2, paramZzuz, localZzvd);
            } else {
              localZzyb.close(localObject3, i, (zzud)localObject1);
            }
          }
        }
        bool = true;
