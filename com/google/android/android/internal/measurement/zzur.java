  ...
  implements zzxi
{
    ...
    throws IOException
  {
    ...
    if (zzbur.zzbuh < zzbur.zzbui)
    {
      ...
      zzbuh += 1;
      paramZzxj.parseAttributes(localObject, this, paramZzuz);
  ...
  private final Object parse(zzxj paramZzxj, zzuz paramZzuz)
    throws IOException
  {
    int i = zzbus;
    zzbus = (0 >>> 3 << 3 | 0x4);
  ...
  public final void addData(List paramList, zzxj paramZzxj, zzuz paramZzuz)
    throws IOException
  {
    int i = 0;
    if ((i & 0x7) == 3)
    {
      ...
      do
      {
        paramList.add(parse(paramZzxj, paramZzuz));
        if (zzbur.zzuw()) {
          break;
        }
        if (zzbut != 0) {
  ...
  public final void addValue(List paramList)
    throws IOException
  {
  ...
  public final void addValue(List paramList, zzxj paramZzxj, zzuz paramZzuz)
    throws IOException
  {
    int i = 0;
    if ((i & 0x7) == 2)
  ...
  public final void addValue(Map paramMap, zzwm paramZzwm, zzuz paramZzuz)
    throws IOException
  {
    zzat(2);
    i = zzbur.zzup();
  ...
  public final void getIndex(List paramList)
    throws IOException
  {
  ...
  public final void group(List paramList)
    throws IOException
  {
    if ((paramList instanceof zzvn))
    {
  ...
  public final void nextToken(List paramList)
    throws IOException
  {
    if ((paramList instanceof zzvn))
    {
  ...
  public final void parseAttributes(List paramList)
    throws IOException
  {
  ...
  public final Object readValue(zzxj paramZzxj, zzuz paramZzuz)
    throws IOException
  {
    zzat(3);
    return parse(paramZzxj, paramZzuz);
  }
  
  public final void split(List paramList)
    throws IOException
  {
    if ((paramList instanceof zzvn))
    {
  ...
  public final void trim(List paramList)
    throws IOException
  {
    int j;
    if ((paramList instanceof zzwh))
  ...
  public final void xor(List paramList)
    throws IOException
  {
    if ((0 & 0x7) == 2)
    {
