...
final class zzvd<FieldDescriptorType extends com.google.android.gms.internal.measurement.zzvf<FieldDescriptorType>>
{
  ...
  private static int broadcast(zzvf paramZzvf, Object paramObject)
  {
    zzyq localZzyq = paramZzvf.zzvw();
    int k = paramZzvf.next();
    if (paramZzvf.zzvy())
    {
      ...
      i = j;
      while (paramZzvf.hasNext()) {
        i += getKey(localZzyq, k, paramZzvf.next());
      }
      return i;
    }
    return getKey(localZzyq, k, paramObject);
  }
  
  private static int broadcast(Map.Entry paramEntry)
  {
    ...
    if ((localZzvf.zzvx() == zzyv.zzcet) && (!localZzvf.zzvy()) && (!localZzvf.zzvz()))
    {
      if ((localObject instanceof zzvw)) {
        return zzut.write(((zzvf)paramEntry.getKey()).next(), (zzvw)localObject);
      }
      return zzut.write(((zzvf)paramEntry.getKey()).next(), (zzwt)localObject);
    }
    return broadcast(localZzvf, localObject);
  }
  ...
  static int getKey(zzyq paramZzyq, int paramInt, Object paramObject)
  {
    int i = zzut.zzbb(paramInt);
    paramInt = i;
    if (paramZzyq == zzyq.zzcdz)
    {
      zzvo.equals((zzwt)paramObject);
      paramInt = i << 1;
    }
  ...
  private static void setField(zzyq paramZzyq, Object paramObject)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 191	com/google/android/android/internal/measurement/zzvo:checkNotNull	(Ljava/lang/Object;)Ljava/lang/Object;
    //   4: pop
    //   5: getstatic 197	com/google/android/android/internal/measurement/zzve:zzbvt	[I
    //   8: aload_0
    //   9: invokevirtual 200	com/google/android/android/internal/measurement/zzyq:zzyp	()Lcom/google/android/android/internal/measurement/zzyv;
    //   12: invokevirtual 205	java/lang/Enum:ordinal	()I
    //   15: iaload
    //   16: istore_2
    //   17: iconst_0
    //   18: istore_3
    ...
    //   209: ifeq +4 -> 213
    //   212: return
    //   213: new 161	java/lang/IllegalArgumentException
    //   216: dup
    //   217: ldc -93
    //   219: invokespecial 166	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   222: astore_0
    //   223: goto +3 -> 226
    //   226: aload_0
    //   227: athrow
  ...
  private static int write(zzyq paramZzyq, Object paramObject)
  {
    ...
    case 12: 
      if ((paramObject instanceof zzud)) {
        return zzut.size((zzud)paramObject);
      }
    ...
    return zzut.add(((Double)paramObject).doubleValue());
  }
    ...
    throws IOException
  {
    if (paramZzyq == zzyq.zzcdz)
    {
      ...
      zzvo.equals(paramZzyq);
      paramZzut.next(paramInt, 3);
      paramZzyq.b(paramZzut);
      paramZzut.next(paramInt, 4);
      return;
    }
    paramZzut.next(paramInt, paramZzyq.zzyq());
    switch (zzve.zzbuu[paramZzyq.ordinal()])
    {
    default: 
      return;
    ...
    case 11: 
      ...
      return;
    case 10: 
      paramZzut.c((zzwt)paramObject);
      return;
    case 9: 
      ((zzwt)paramObject).b(paramZzut);
      return;
    case 8: 
  ...
  public final int zzvu()
  {
    ...
    while (j < zzbvq.zzxw())
    {
      ...
      i += broadcast((zzvf)((Map.Entry)localObject).getKey(), ((Map.Entry)localObject).getValue());
      j += 1;
    }
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      i += broadcast((zzvf)localEntry.getKey(), localEntry.getValue());
    }
    return i;
  }
  ...
  public final int zzvv()
  {
    ...
    while (j < zzbvq.zzxw())
    {
      i += broadcast(zzbvq.zzbu(j));
      j += 1;
    }
    Iterator localIterator = zzbvq.zzxx().iterator();
    while (localIterator.hasNext()) {
      i += broadcast((Map.Entry)localIterator.next());
    }
    return i;
  }
}
