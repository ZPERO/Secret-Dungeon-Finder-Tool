  ...
  implements Drawable.Callback
{
  ...
  private VectorDrawableCompat.VectorDrawableCompatState zanm;
  ...
  public DrawableContainer(Drawable paramDrawable1, Drawable paramDrawable2)
  {
    this(null);
    Object localObject = paramDrawable1;
    if (paramDrawable1 == null) {
      localObject = DrawableWrapperDonut.zacg();
    }
    ...
    if (paramDrawable2 == null) {
      paramDrawable1 = DrawableWrapperDonut.zacg();
    }
    zano = paramDrawable1;
  ...
  DrawableContainer(VectorDrawableCompat.VectorDrawableCompatState paramVectorDrawableCompatState)
  {
    zanm = new VectorDrawableCompat.VectorDrawableCompatState(paramVectorDrawableCompatState);
  }
