...
public class TextAppearance
{
  ...
  public Typeface getFont(Context paramContext)
  {
    ...
    try
    {
      try
      {
        paramContext = ResourcesCompat.getFont(paramContext, i);
        font = paramContext;
        if (font != null)
        {
          paramContext = font;
  ...
  public void getFontAsync(Context paramContext, final TextPaint paramTextPaint, final ResourcesCompat.FontCallback paramFontCallback)
  {
    ...
    try
    {
      ResourcesCompat.getFont(paramContext, i, new ResourcesCompat.FontCallback()
      {
    ...
    catch (UnsupportedOperationException paramContext) {}catch (Resources.NotFoundException paramContext) {}
  }
