  ...
  implements MenuView
{
  ...
  private final TransitionSet mImpl;
  ...
  public BottomNavigationMenuView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    mImpl = new AutoTransition();
    mImpl.setOrdering(0);
    mImpl.setDuration(115L);
    mImpl.setInterpolator(new FastOutSlowInInterpolator());
    mImpl.addTransition(new TextScale());
  ...
  public void updateMenuView()
  {
    ...
    if (localObject != null)
    {
      ...
      if (k != selectedItemId) {
        TransitionManager.beginDelayedTransition(this, mImpl);
      }
