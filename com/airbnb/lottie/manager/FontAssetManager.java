...
public class FontAssetManager
{
  ...
  private Typeface getFontFamily(String paramString)
  {
    ...
    if (localObject2 != null) {
      localObject1 = ((FontAssetDelegate)localObject2).fetchFont(paramString);
    }
    Object localObject3 = delegate;
    ...
    if (localObject3 != null)
    {
      ...
      if (localObject1 == null)
      {
        localObject3 = ((FontAssetDelegate)localObject3).getFontPath(paramString);
        localObject2 = localObject1;
        if (localObject3 != null) {
          localObject2 = Typeface.createFromAsset(assetManager, (String)localObject3);
        }
      }
    }
    ...
    if (localObject2 == null)
    {
      ...
      localObject1 = Typeface.createFromAsset(assetManager, (String)localObject1);
    }
    fontFamilies.put(paramString, localObject1);
    return localObject1;
  }
  ...
  {
    tempPair.add(paramString1, paramString2);
  ...
  public void setDelegate(FontAssetDelegate paramFontAssetDelegate)
  {
    delegate = paramFontAssetDelegate;
  }
}
