...
public final class HttpEngine
{
    ...
    throws IOException
  {
    ...
    paramCacheRequest = new Source()
    {
      ...
      public long read(Buffer paramAnonymousBuffer, long paramAnonymousLong)
        throws IOException
      {
        BufferedSource localBufferedSource = val$source;
        try
        {
          paramAnonymousLong = localBufferedSource.read(paramAnonymousBuffer, paramAnonymousLong);
    ...
    implements Interceptor.Chain
  {
      ...
      throws IOException
    {
      ...
      if ((i == 204) || (i == 205))
      {
        if (paramRequest.body().contentLength() <= 0L) {
          return paramRequest;
        }
        localObject1 = new StringBuilder();
