  ...
  implements HttpStream
{
  ...
  public static Response.Builder readHttp2HeadersList(List paramList)
    throws IOException
  {
  ...
  public static Response.Builder readSpdy3HeadersList(List paramList)
    throws IOException
  {
    Headers.Builder localBuilder = new Headers.Builder();
  ...
  public static List spdy3HeadersList(Request paramRequest)
  {
    Headers localHeaders = paramRequest.headers();
  ...
  public void cancel()
  {
    FramedStream localFramedStream = stream;
    if (localFramedStream != null) {
      localFramedStream.closeLater(ErrorCode.CANCEL);
    }
  }
    ...
    throws IOException
  {
    ...
    if (framedConnection.getProtocol() == Protocol.HTTP_2) {
      ...
      paramRequest = spdy3HeadersList(paramRequest);
    }
