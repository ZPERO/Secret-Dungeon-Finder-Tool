  ...
  extends Closeable
{
  ...
  public static abstract interface Handler
  {
    ...
    public abstract void headers(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, List paramList, HeadersMode paramHeadersMode);
    ...
    public abstract void pushPromise(int paramInt1, int paramInt2, List paramList)
      throws IOException;
