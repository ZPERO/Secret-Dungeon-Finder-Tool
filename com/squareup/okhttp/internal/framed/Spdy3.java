  ...
  implements Variant
{
    ...
    implements FrameReader
  {
      ...
      throws IOException
    {
      ...
      try
      {
        int j = localBufferedSource.readInt();
        localBufferedSource = source;
        int k = localBufferedSource.readInt();
        int i;
        if ((0x80000000 & j) != 0) {
          i = 1;
        } else {
    ...
    implements FrameWriter
  {
    ...
    private void writeNameValueBlockToBuffer(List paramList)
      throws IOException
    {
