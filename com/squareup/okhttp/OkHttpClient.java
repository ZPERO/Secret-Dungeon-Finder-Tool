  ...
  implements Cloneable
{
  ...
  private SSLSocketFactory getDefaultSSLSocketFactory()
  {
    for (;;)
    {
      try
      {
        localObject = defaultSslSocketFactory;
        if (localObject != null) {}
      }
      ...
      try
      {
        ...
        defaultSslSocketFactory = (SSLSocketFactory)localObject;
      }
  ...
  public OkHttpClient setConnectionSpecs(List paramList)
  {
  ...
  public OkHttpClient setProtocols(List paramList)
  {
