...
public class MediaSessionCompat
{
  ...
  private MediaSessionCompat(Context paramContext, String paramString, ComponentName paramComponentName, PendingIntent paramPendingIntent, Bundle paramBundle)
  {
    if (paramContext != null)
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        {
          mImpl = new MediaSessionImplApi28(paramContext, paramString, paramBundle);
          setCallback(new Callback() {});
          mImpl.setMediaButtonReceiver(paramComponentName);
        }
        else if (Build.VERSION.SDK_INT >= 21)
        {
          mImpl = new MediaSessionImplApi21(paramContext, paramString, paramBundle);
          setCallback(new Callback() {});
          mImpl.setMediaButtonReceiver(paramComponentName);
        }
  ...
  public static abstract class Callback
  {
      ...
      extends Handler
    {
      ...
      {
        if (what == 1) {
          handleMediaPlayPauseKeySingleTapIfPending((MediaSessionManager.RemoteUserInfo)obj);
        }
      }
    }
    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
    ...
    MediaSessionImplApi21(Context paramContext, String paramString, Bundle paramBundle)
    {
      ...
      mToken = new MediaSessionCompat.Token(MediaSessionCompatApi21.getSessionToken(mSessionObj), new ExtraSession(), paramBundle);
    }
      ...
      extends IMediaSession.Stub
    {
      ...
      public void registerCallbackListener(IMediaControllerCallback paramIMediaControllerCallback)
      {
        if (!mDestroyed)
        {
          ...
          localObject = new MediaSessionManager.RemoteUserInfo((String)localObject, Binder.getCallingPid(), Binder.getCallingUid());
    ...
    extends MediaSessionCompat.MediaSessionImplApi21
  {
    ...
    public final MediaSessionManager.RemoteUserInfo getCurrentControllerInfo()
    {
      return new MediaSessionManager.RemoteUserInfo(((MediaSession)mSessionObj).getCurrentControllerInfo());
    }
    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
    ...
    public void setCurrentControllerInfo(MediaSessionManager.RemoteUserInfo paramRemoteUserInfo)
    {
      ...
      catch (Throwable paramRemoteUserInfo)
      {
        throw paramRemoteUserInfo;
      }
    }
      ...
      extends IMediaSession.Stub
    {
      ...
      public void registerCallbackListener(IMediaControllerCallback paramIMediaControllerCallback)
      {
        ...
        mControllerCallbacks.register(paramIMediaControllerCallback, localRemoteUserInfo);
        return;
      }
      ...
      extends Handler
    {
      ...
      public void handleMessage(Message paramMessage)
      {
        ...
        setCurrentControllerInfo(new MediaSessionManager.RemoteUserInfo(((Bundle)localObject).getString("data_calling_pkg"), ((Bundle)localObject).getInt("data_calling_pid"), ((Bundle)localObject).getInt("data_calling_uid")));
    ...
    implements Parcelable
  {
    ...
    public Bundle toBundle()
    {
      ...
      if (localObject != null) {
        BundleCompat.putBinder(localBundle, "android.support.v4.media.session.EXTRA_BINDER", ((IInterface)localObject).asBinder());
      }
