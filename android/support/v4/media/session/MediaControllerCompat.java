...
import androidx.core.package_7.ComponentActivity.ExtraData;
...
public final class MediaControllerCompat
{
  ...
  public static MediaControllerCompat getMediaController(Activity paramActivity)
  {
    ...
    {
      paramActivity = (MediaControllerExtraData)((ComponentActivity)paramActivity).getExtraData(MediaControllerExtraData.class);
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
      ...
      throws RemoteException
    {
      ...
      mControllerObj = MediaControllerCompatApi21.fromToken(paramContext, mSessionToken.getToken());
