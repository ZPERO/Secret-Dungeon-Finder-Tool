...
public final class MediaBrowserCompat
{
    ...
    extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      if ((localObject1 != null) && (((WeakReference)localObject1).get() != null))
      {
        ...
        MediaSessionCompat.ensureClassLoader((Bundle)localObject3);
        ((MediaBrowserCompat.MediaBrowserServiceCallbackImpl)localObject1).onLoadChildren(localMessenger, ((Bundle)localObject2).getString("data_media_item_id"), ((Bundle)localObject2).getParcelableArrayList("data_media_item_list"), localBundle, (Bundle)localObject3);
        return;
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
  {
    ...
    public void onConnected()
    {
      ...
      mServiceVersion = ((Bundle)localObject1).getInt("extra_service_version", 0);
